...
<div class="card-tab page-section" id="Edit Admin Details">
    <div class="mb-4">
        <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">編輯管理員 · {$user|escape}</h1>
        <p class="text-sm text-muted m-0 mt-2">更新身分、登入憑證與遊戲內管理員密碼。</p>
    </div>
    ...
    <form method="post" action="" class="space-y-4" autocomplete="off">
        ...
        {if $change_pass}
            <div class="card">
                ...
                <div class="card__body space-y-3">
                    <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                        <div>
                            <label class="label" for="password">新密碼</label>
                    ...
                    <div class="flex items-center gap-2 mt-2" style="border-top:1px solid var(--border);padding-top:0.75rem">
                        ...
                        <label for="a_useserverpass" class="text-sm font-medium" style="margin:0">使用遊戲內管理員密碼</label>
        ...
        <div class="flex justify-end gap-2">
            ...
            <button type="submit" class="btn btn--primary btn--sm" id="editmod"
                    data-testid="edit-admin-save"><i data-lucide="save"></i> 儲存變更</button>
        </div>
    </form>
</div>
