        ...
        <div class="flex items-center justify-between gap-4 mb-4" style="flex-wrap:wrap">
            <div>
                ...
                <p class="text-sm text-muted m-0 mt-2">
                    Bannissements que les joueurs ont demandé de reconsidérer.
                </p>
            </div>
        ...
        {if $protest_list|@count == 0}
            ...
            <div class="card" data-testid="protests-empty">
                <div class="empty-state">
                    ...
                    <h2 class="empty-state__title">Aucun appel actif</h2>
                    <p class="empty-state__body">Rien n&rsquo;attend de révision. Les nouveaux appels de bannissement apparaîtront ici au fur et à mesure que les joueurs les soumettront.</p>
                </div>
            </div>
        {else}
                            ...
                            <div class="row-actions">
                                {if $permission_editban}
                                    <button type="button"
                                            ...
                                            data-archiv="1">
                                        <span data-confirm-label>Supprimer</span>
                                    </button>
                                {/if}
...
(function () {
    ...
    function arm(btn) {
        ...
        labelEl.textContent = 'Cliquez pour confirmer';
        btn.setAttribute('data-pending', 'true');
        btn.setAttribute('aria-label', 'Cliquez à nouveau dans les 3 secondes pour confirmer la suppression');
    ...
    document.addEventListener('click', function (e) {
        ...
        a.call(A.ProtestsRemove, { pid: pid, archiv: '1' }).then(function (r) {
            ...
            toast('success', 'Appel archivé', 'Restaurable depuis la page des appels archivés si nécessaire.');
        });
    });
})();
</script>
