...
<section class="p-6 space-y-6" style="max-width:64rem">
    <header>
        <h1 style="font-size:1.5rem;font-weight:600;margin:0">BAN 申し立て</h1>
        <p class="text-sm text-muted m-0 mt-2">
            アカウントへの BAN が誤りだと思われる場合は、以下から申し立てを送信してください。
            運営チームが確認します。まず<a href="index.php?p=banlist" style="color:var(--accent)">BAN リスト</a>で BAN を確認してください。
        </p>
    </header>
    ...
    <div class="grid gap-4" style="grid-template-columns:minmax(0,2fr) minmax(0,1fr)">
        <form class="card"
            ...
            <div class="card__header">
                <div>
                    <h3>あなたの情報</h3>
                    <p><span style="color:var(--danger)">*</span> 印の付いた項目は必須です。</p>
                </div>
            ...
            <div class="card__body space-y-4">
                ...
                <div>
                    <label class="label" for="protest-type">BAN タイプ</label>
                    <select id="protest-type"
                        ...
                        <option value="1" {if $ip_first}selected{/if}>IP アドレス</option>
                    </select>
                </div>

                <div data-protest-row="steam" {if $ip_first}hidden{/if}>
                    <label class="label" for="protest-steam">
                        あなたの SteamID <span style="color:var(--danger)">*</span>
                    </label>
                ...
                <div data-protest-row="ip" {if !$ip_first}hidden{/if}>
                    <label class="label" for="protest-ip">
                        あなたの IP <span style="color:var(--danger)">*</span>
                    </label>
                    <input id="protest-ip"
                           type="text"
                           name="IP"
                ...
                <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                    <div>
                        <label class="label" for="protest-name">
                            ゲーム内の名前 <span style="color:var(--danger)">*</span>
                        </label>
                ...
                <div>
                    <label class="label" for="protest-reason">
                        BAN 解除の理由 <span style="color:var(--danger)">*</span>
                    </label>
                    <textarea id="protest-reason"
                              ...
                              placeholder="できるだけ詳しく記述してください。状況が詳しいほど、申し立てが迅速に確認されます。">{$reason|escape}</textarea>
                </div>
            </div>
            <div class="card__header" style="justify-content:flex-end;border-top:1px solid var(--border);border-bottom:0">
                <button type="submit"
                    ...
                    <i data-lucide="send-horizontal"></i> 申し立てを送信
                </button>
            </div>
        </form>
        ...
        <aside class="card">
            ...
            <div class="card__body space-y-4 text-sm">
                <p class="m-0 text-muted">
                    申し立てを送信すると、運営チームに通知されます。
                    元の BAN の証拠とここで提供された状況を確認します。
                </p>
                <p class="m-0 text-muted">
                    メールで返信が届きます。通常は
                    <span class="font-medium" style="color:var(--text)">24 時間以内</span>です。
                </p>
                <div class="space-y-3"
                    ...
                    <div class="flex gap-2 items-start">
                        ...
                        <p class="m-0 text-xs text-muted">
                            運営チームに対する脅迫、嫌がらせ、虐待は BAN 解除の対象とならず、
                            すべてのサービスから永久に BAN されます。
                        </p>
                    </div>
                </div>
            </div>
