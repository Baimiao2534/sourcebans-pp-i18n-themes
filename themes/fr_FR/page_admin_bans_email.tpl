...
<section class="p-6" data-testid="banemail-section" style="max-width:48rem">
    <div class="mb-6">
        <h1 style="font-size:1.5rem;font-weight:600;margin:0">Envoyer un e-mail au joueur</h1>
        <p class="text-sm text-muted m-0 mt-2">
            Envoi à <span class="font-mono" data-testid="banemail-addr">{$email_addr|escape}</span>.
        </p>
    </div>
    <form class="card p-6 space-y-4"
        ...
        <div>
            ...
            <textarea class="textarea"
                      ...
                      name="message"
                      rows="8"
                      placeholder="Que souhaitez-vous faire savoir au joueur ?"
        ...
        <div class="flex justify-end gap-2"
            ...
            <button type="button"
                    ...
                    data-testid="banemail-back">Retour</button>
...
(function () {
    ...
    window.CheckEmail = function (type, id) {
        ...
        if (!subject || !subject.value) { setMsg('subject.msg', 'Vous devez saisir un objet pour l\'e-mail.'); err++; }
        else { setMsg('subject.msg', ''); }
        if (!message || !message.value) { setMsg('message.msg', 'Vous devez saisir un message pour l\'e-mail.'); err++; }
        ...
        a.call(A.SystemSendMail, {
            ...
            if (!r || r.ok === false) {
                toast('error', 'Échec de l\'e-mail', (r && r.error && r.error.message) || 'Erreur inconnue');
                return;
            }
            ...
            toast('success', (msg && msg.title) || 'E-mail envoyé', (msg && msg.body) || "L'e-mail a été envoyé.");
            if (msg && msg.redir) {
