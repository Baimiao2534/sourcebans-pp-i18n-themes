                ...
                <tr data-testid="blockit-row--{$serv.num}-">
                    ...
                    <td>
                        <div id="srv_-{$serv.num}-"
                             ...
                             data-testid="blockit-status--{$serv.num}-">Ожидание&hellip;</div>
                    </td>
                </tr>
                -{/foreach}-
            </tbody>
            ...
            sb.api.call(Actions.BlockitBlockPlayer, { check: CHECK, sid: sid, num: num, type: TYPE, length: LENGTH })
                .then(function (r) {
                    ...
                    if (d.status === 'no_connect') {
                        ...
                        sb.setHTML('srv_' + num, "<span class='text-xs font-semibold' style='color:var(--success)'><u>Игрок найден и заблокирован!</u></span>");
                        setCounter(-1);
                    } else {
