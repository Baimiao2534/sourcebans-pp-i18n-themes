...
<form method="get"
    ...
    <div class="card__body space-y-3">
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <label class="label" for="search-bans-name" style="grid-column:1;align-self:end">Ник</label>
            <input class="input"
                   id="search-bans-name"
                   type="text"
        ...
        {if NOT $hideplayerips}
            <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
                ...
                <input class="input font-mono"
                       id="search-bans-ip"
                       type="text"
                       placeholder="Точный IP-адрес&hellip;"
        ...
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <label class="label" for="search-bans-reason" style="grid-column:1;align-self:end">Причина</label>
            <input class="input"
        ...
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <label class="label" for="search-bans-btype">Тип</label>
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                <select class="select"
        ...
        {if NOT $hideadminname}
            <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
                <label class="label" for="search-bans-admin">Администратор</label>
                <div class="flex items-center gap-2" style="flex-wrap:wrap">
                    <select class="select"
        ...
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <label class="label" for="search-bans-server">Сервер</label>
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                <select class="select"
        ...
        {if $is_admin}
            <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
                <label class="label" for="search-bans-comment" style="grid-column:1;align-self:end">Комментарий</label>
                <input class="input"
