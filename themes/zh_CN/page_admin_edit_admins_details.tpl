...
<div class="card-tab page-section" id="Edit Admin Details">
    <div class="mb-4">
        <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">编辑管理员 · {$user|escape}</h1>
        <p class="text-sm text-muted m-0 mt-2">更新身份信息、登录凭证以及游戏内管理员密码。</p>
    </div>
    ...
    <form method="post" action="" class="space-y-4" autocomplete="off">
            ...
            <div class="card">
                ...
                <div class="card__body space-y-3">
                    ...
                    <div class="flex items-center gap-2 mt-2" style="border-top:1px solid var(--border);padding-top:0.75rem">
                        ...
                        <label for="a_useserverpass" class="text-sm font-medium" style="margin:0">使用游戏内管理员密码</label>
        ...
        <div class="flex justify-end gap-2">
            ...
            <button type="submit" class="btn btn--primary btn--sm" id="editmod"
                    data-testid="edit-admin-save"><i data-lucide="save"></i> 保存更改</button>
        </div>
    </form>
</div>
