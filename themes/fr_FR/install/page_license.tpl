...
<p class="lead">
    Vous devez accepter la licence ci-dessous pour installer le panneau.
    Le texte intégral se trouve à
    <a href="https://www.elastic.co/licensing/elastic-license"
       target="_blank" rel="noopener">elastic.co/licensing/elastic-license</a>;
    les plugins SourceMod fournis avec cette installation sont séparément sous licence
...
<form method="post"
    ...
    <label class="flex items-center gap-2"
        ...
        <input type="checkbox"
               ...
               required>
        <span>J'ai lu et j'accepte la licence ci-dessus.</span>
    </label>
