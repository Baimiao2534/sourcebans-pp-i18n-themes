...
<div class="card-tab page-section" id="Edit Admin Groups">
    <div class="mb-4">
        <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">Modifier l'administrateur · {$group_admin_name|escape}</h1>
        <p class="text-sm text-muted m-0 mt-2">Déplacez <strong>{$group_admin_name|escape}</strong> entre les groupes d'administrateurs web et serveur.</p>
    </div>
    ...
    <form method="post" action="" class="space-y-4">
        ...
        <div class="card">
            <div class="card__header">
                <div>
                    <h3>Groupe d'administrateurs web</h3>
                    <p>Groupe qui contrôle l'accès au panneau web.</p>
                </div>
            </div>
            <div class="card__body">
                <label class="label" for="wg">Groupe d'administrateurs web</label>
        ...
        <div class="card">
            <div class="card__header">
                <div>
                    <h3>Groupe d'administrateurs serveur</h3>
                    <p>Groupe SourceMod qui contrôle les permissions d'administrateur en jeu.</p>
                </div>
            </div>
            <div class="card__body">
                <label class="label" for="sg">Groupe d'administrateurs serveur</label>
        ...
        <div class="flex justify-end gap-2">
            ...
            <button type="submit" class="btn btn--primary btn--sm" id="agroups"
                    data-testid="edit-admin-group-save"><i data-lucide="save"></i> Enregistrer les modifications</button>
        </div>
    </form>
</div>
