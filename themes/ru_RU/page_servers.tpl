        ...
        <div>
            ...
            <p class="text-sm text-muted m-0 mt-2"
               ...
               data-total="{$server_list|@count}">
                {$server_list|@count} настроено
                <span data-online-count>&middot; <span data-online-num>0</span> онлайн</span>
            </p>
        </div>
        {*
        ...
        {if $can_use_context_menu}
            ...
            <p class="text-xs text-muted m-0 servers-rcon-hint"
               ...
               style="max-width:24rem;text-align:right">
                Щёлкните правой кнопкой мыши по игроку на развёрнутой карточке, чтобы просмотреть его профиль, скопировать SteamID или кикнуть/забанить/заблокировать его. Действия «кикнуть/забанить/заблокировать» доступны только на серверах, к которым у вас есть доступ RCON.
            </p>
        {/if}
    </header>
    ...
    {if $server_list|@count == 0}
        ...
        <div class="card" data-testid="servers-empty">
            <div class="empty-state">
                ...
                <h2 class="empty-state__title">Серверы пока не настроены</h2>
                <p class="empty-state__body">
                    Как только вы добавите сервер, здесь появятся игроки, статус и актуальное количество для посетителей.
                </p>
                {if $can_add_server}
        ...
        <article class="card"
            ...
            <div class="card__body">
                ...
                <dl class="grid gap-2 text-xs"
                    ...
                    <dt class="text-muted flex items-center gap-1" style="margin:0">
                        <i data-lucide="map" style="width:13px;height:13px"></i> Карта
                    </dt>
                    <dd class="font-mono text-faint" data-testid="server-map" style="margin:0">&mdash;</dd>

                    <dt class="text-muted flex items-center gap-1" style="margin:0">
                        <i data-lucide="users" style="width:13px;height:13px"></i> Игроки
                    </dt>
            ...
            <div id="server-players-{$server.sid}"
                ...
                *}
                ...
                <p class="text-xs text-muted m-0" data-empty-message>Сейчас нет подключённых игроков.</p>
