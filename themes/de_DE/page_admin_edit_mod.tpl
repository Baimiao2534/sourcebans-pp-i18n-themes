...
<form method="post"
    ...
    <div class="card">
        <div class="card__header">
            <div>
                <h3>Mod bearbeiten</h3>
                <p>Aktualisieren Sie die Konfiguration für diesen Spiel-Mod.</p>
            </div>
        </div>
        <div class="card__body space-y-4" style="max-width:42rem">
            ...
            <div>
                ...
                <p class="text-xs text-muted" style="margin-top:0.25rem">
                    Erste Ziffer (X) von <span class="font-mono">STEAM_X:Y:Z</span>, wie von diesem Mod gerendert.
                </p>
            </div>
            ...
            <div class="flex justify-end gap-2"
                ...
                <a class="btn btn--ghost btn--sm"
                   ...
                   data-testid="editmod-cancel">Zurück</a>
