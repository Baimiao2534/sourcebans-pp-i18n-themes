...
<section class="p-6 space-y-6" style="max-width:64rem">
    <header>
        <h1 style="font-size:1.5rem;font-weight:600;margin:0">申訴封禁</h1>
        <p class="text-sm text-muted m-0 mt-2">
            認為您帳號的封禁是誤判？在下方提交申訴，管理團隊將會審核。請先在
            <a href="index.php?p=banlist" style="color:var(--accent)">封禁列表</a> 確認該封禁。
        </p>
    </header>
    ...
    <div class="grid gap-4" style="grid-template-columns:minmax(0,2fr) minmax(0,1fr)">
        <form class="card"
            ...
            <div class="card__header">
                <div>
                    <h3>您的資訊</h3>
                    <p>標記 <span style="color:var(--danger)">*</span> 的欄位為必填。</p>
                </div>
            ...
            <div class="card__body space-y-4">
                ...
                <div>
                    <label class="label" for="protest-type">封禁類型</label>
                ...
                <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                    <div>
                        <label class="label" for="protest-name">
                            遊戲內名稱 <span style="color:var(--danger)">*</span>
                        </label>
                    ...
                    <div>
                        <label class="label" for="protest-email">
                            您的電子郵件 <span style="color:var(--danger)">*</span>
                        </label>
                ...
                <div>
                    <label class="label" for="protest-reason">
                        為什麼應該解封？ <span style="color:var(--danger)">*</span>
                    </label>
                    <textarea id="protest-reason"
                              ...
                              placeholder="請盡可能詳細描述。管理員掌握的背景資訊越多，您的申訴就能越快被審核。">{$reason|escape}</textarea>
                </div>
            </div>
            <div class="card__header" style="justify-content:flex-end;border-top:1px solid var(--border);border-bottom:0">
                <button type="submit"
                    ...
                    <i data-lucide="send-horizontal"></i> 提交申訴
                </button>
            </div>
        </form>
        ...
        <aside class="card">
            ...
            <div class="card__body space-y-4 text-sm">
                <p class="m-0 text-muted">
                    您提交申訴的那一刻，管理團隊便會收到通知。他們會審核原始的封禁證據以及您在此提供的背景資訊。
                </p>
                <p class="m-0 text-muted">
                    您將透過電子郵件收到回覆，通常在
                    <span class="font-medium" style="color:var(--text)">24 小時</span>內。
                </p>
                <div class="space-y-3"
                    ...
                    <div class="flex gap-2 items-start">
                        ...
                        <p class="m-0 text-xs text-muted">
                            針對管理員的威脅、騷擾或辱罵行為不會讓您解封，反而會導致您被所有服務永久封禁。
                        </p>
                    </div>
                </div>
            </div>
