...
<p class="lead">
    Создайте первую учётную запись администратора. Эта учётная запись получит
    флаг разрешений <strong>Owner</strong>, который позволяет выполнять все действия
    в панели, включая создание других администраторов.
</p>
...
<form method="post"
    ...
    <div class="install-section">
        ...
        <div class="install-grid">
            <div>
                <label class="label" for="install-admin-uname">Имя пользователя</label>
                <input class="input"
            ...
            <div>
                <label class="label" for="install-admin-pass1">Пароль</label>
                <input class="input"
                       ...
                       required>
                <p class="text-xs text-muted">Минимум 8 символов.</p>
            </div>

            <div>
                <label class="label" for="install-admin-pass2">Подтвердите пароль</label>
                <input class="input"
            ...
            <div style="grid-column:1/-1">
                ...
                <p class="text-xs text-muted">
                    SteamID в формате <code>STEAM_0:X:NNNNNNN</code>.
                    Используйте <a href="https://steamid.io/" target="_blank" rel="noopener">steamid.io</a>,
                    если у вас персональный URL или SteamID64.
                </p>
            </div>
        </div>
    </div>
