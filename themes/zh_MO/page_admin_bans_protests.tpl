        ...
        {if $protest_list|@count == 0}
            ...
            <div class="card" data-testid="protests-empty">
                <div class="empty-state">
                    ...
                    <h2 class="empty-state__title">沒有進行中的申訴</h2>
                    <p class="empty-state__body">沒有等待審核的項目。新的封禁申訴會在玩家提交時出現在這裡。</p>
                </div>
            </div>
        {else}
...
(function () {
    ...
    function arm(btn) {
        ...
        labelEl.textContent = '點擊以確認';
        btn.setAttribute('data-pending', 'true');
        btn.setAttribute('aria-label', '在 3 秒內再次點擊以確認移除');
    ...
    document.addEventListener('click', function (e) {
        ...
        a.call(A.ProtestsRemove, { pid: pid, archiv: '1' }).then(function (r) {
            ...
            toast('success', '申訴已歸檔', '如需要，可從已歸檔的申訴頁面恢復。');
        });
    });
})();
</script>
