...
<div class="p-6 space-y-6" style="max-width:48rem;margin:2.5rem auto;width:100%">
    ...
    <header class="flex items-center gap-3" data-testid="updater-header">
        ...
        <div>
            <h1 style="font-size:var(--fs-2xl);font-weight:600;margin:0">Обновление SourceBans++</h1>
            <p class="text-sm text-muted m-0 mt-2">Журнал миграции базы данных.</p>
        </div>
    </header>
    ...
    <section class="card">
        <div class="card__header" data-testid="updater-progress">
            <div>
                <h3>Прогресс</h3>
                <p>Каждая строка ниже — шаг из средства миграции.</p>
            </div>
        </div>
        <div class="card__body">
            ...
            {else}
                <p class="text-sm text-muted m-0" data-testid="updater-empty">Обновления не применялись.</p>
            {/if}
        </div>
    </section>
    ...
    <section class="card">
        <div class="card__header" data-testid="updater-cleanup">
            <div>
                <h3>Следующий шаг</h3>
                <p>После завершения удалите каталог <code class="font-mono">/updater</code> перед предоставлением панели администраторам.</p>
            </div>
        </div>
        <div class="card__body">
