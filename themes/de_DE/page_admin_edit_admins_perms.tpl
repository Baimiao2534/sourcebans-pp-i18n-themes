...
<div class="space-y-4" data-testid="admin-edit-perms">
    <div class="mb-4">
        <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">
            Berechtigungen für {$admin_name|escape}
        </h1>
        <p class="text-sm text-muted m-0 mt-2">
            Aktivieren Sie eine übergeordnete Gruppe, um alle darunterliegenden Berechtigungen gleichzeitig ein- oder auszuschalten.
        </p>
    </div>
    ...
    <form id="edit-perms-form" class="space-y-4" autocomplete="off"
        ...
        <div class="card">
            <div class="card__header"><div>
                ...
                <p>Berechtigungen innerhalb des Panels selbst.</p>
            </div></div>
            <div class="card__body">
                <table class="table" style="margin:0;font-size:var(--fs-sm)">
                    ...
                    <tbody>
                        ...
                        {/if}
                        <tr>
                            <td><strong>Administratoren verwalten</strong></td>
                            <td class="text-center">
                        ...
                        <tr>
                            <td><strong>Serververwaltung</strong></td>
                            <td class="text-center">
                        ...
                        <tr>
                            <td><strong>Bannverwaltung</strong></td>
                            <td class="text-center">
                        ...
                        <tr>
                            <td><strong>Gruppenverwaltung</strong></td>
                            <td class="text-center">
                        ...
                        <tr>
                            <td><strong>Web-Panel-Einstellungen</strong></td>
                            <td class="text-center">
                        ...
                        <tr>
                            <td><strong>Mods verwalten</strong></td>
                            <td class="text-center">
        ...
        <div class="card">
            <div class="card__header"><div>
                ...
                <p>SourceMod-Administrator-Flags, die auf alle Server angewendet werden, die dieser Administrator verwalten kann.</p>
            </div></div>
            <div class="card__body">
                <table class="table" style="margin:0;font-size:var(--fs-sm)">
                    <thead>
        ...
        <div class="flex gap-2">
            <button type="submit" class="btn btn--primary"
                    data-testid="admin-edit-perms-save">Änderungen speichern</button>
            <a class="btn btn--ghost" href="index.php?p=admin&amp;c=admins">Abbrechen</a>
        </div>
    </form>
</div>
