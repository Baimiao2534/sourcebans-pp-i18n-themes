    ...
    <div class="card__header">
        <div>
            <h2 style="margin:0;font-size:0.95rem;font-weight:600">
                Elastic License 2.0 (Web パネル) &middot; GPLv3 (SourceMod プラグイン)
            </h2>
        </div>
    </div>
