...
{else}
    ...
    <div class="p-6" style="max-width:48rem">
        <div class="mb-6">
            ...
            <p class="text-sm text-muted m-0 mt-2">在所有已连接的服务器上禁言、禁字或综合禁言某位玩家。</p>
        </div>
        ...
        <form id="addcomm-form" class="card p-6 space-y-4" onsubmit="return false;" data-testid="addcomm-form">
            ...
            <div>
                ...
                <p class="text-xs text-muted mt-1" id="addcomm-steam-help">
                    接受的格式：
                    <code>STEAM_0:1:N</code>、<code>[U:1:N]</code> 或 17 位 SteamID64。
                </p>
            ...
            <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                <div>
                    ...
                    <select class="select" id="type" name="type" data-testid="addcomm-type">
                        <option value="1"{if $prefill_type == 1} selected{/if}>禁言（语音）</option>
                        <option value="2"{if $prefill_type == 2} selected{/if}>禁字（聊天）</option>
                        <option value="3"{if $prefill_type == 3} selected{/if}>综合禁言（聊天和语音）</option>
                    </select>
                </div>
                <div>
            ...
            <div>
                ...
                <select class="select"
                    ...
                    <optgroup label="违规">
                        ...
                        <option value="Admin disrespect">对管理员不敬</option>
...
(function () {
    ...
    document.addEventListener('click', function (e) {
        ...
        if (reason === 'other') {
            ...
            if (!reason) {
                setMsg('reason.msg', '请在文本框中描述封禁原因。');
        ...
        a.call(A.CommsAdd, {
            ...
            if (r.ok === false) {
                var err = (r.error && r.error.message) || '未知错误';
                toast('error', '封禁未添加', err);
