        ...
        <span class="filters-details__summary-label">
            ...
            {if $active_filter_count > 0}
                <span class="filters-details__count"
                      ...
                      aria-label="{$active_filter_count} aktive(r) Filter">
                    &middot; {$active_filter_count} aktiv
                </span>
            {/if}
        </span>
...
<form method="get"
    ...
    *}
    <div class="card__header filters-details__header">
        <div>
            <p>Kombinieren Sie beliebige Filter unten — der Server schränkt die Administratorliste auf Zeilen ein, die <strong>jedem</strong> ausgefüllten Filter entsprechen (AND-Logik).</p>
        </div>
    </div>
    ...
    <div class="card__body space-y-3">
        <div class="grid gap-3" style="grid-template-columns:12rem 1fr;align-items:end">
            ...
            <div class="flex gap-2" style="flex-wrap:wrap">
                <input class="input"
                       ...
                       name="name"
                       type="text"
                       placeholder="Gegen Panel-Login abgleichen&hellip;"
                ...
                <select class="select"
                        ...
                        aria-label="Login-Name-Abgleichmodus"
                        style="width:9rem">
                    <option value="0"{if $active_filter_name_match == '0'} selected{/if}>Genaue Übereinstimmung</option>
                    <option value="1"{if $active_filter_name_match != '0'} selected{/if}>Teilweise Übereinstimmung</option>
                </select>
            </div>
        </div>
        ...
        <div class="grid gap-3" style="grid-template-columns:12rem 1fr;align-items:end">
            ...
            <div class="flex gap-2" style="flex-wrap:wrap">
                ...
                <select class="select"
                        ...
                        aria-label="Steam-ID-Abgleichmodus"
                        style="width:9rem">
                    <option value="0"{if $active_filter_steam_match != '1'} selected{/if}>Genaue Übereinstimmung</option>
                    <option value="1"{if $active_filter_steam_match == '1'} selected{/if}>Teilweise Übereinstimmung</option>
                </select>
            </div>
        </div>
            ...
            <div class="grid gap-3" style="grid-template-columns:12rem 1fr;align-items:end">
                ...
                <div class="flex gap-2" style="flex-wrap:wrap">
                    <input class="input"
                           ...
                           name="admemail"
                           type="email"
                           placeholder="Gegen Panel-E-Mail abgleichen&hellip;"
                    ...
                    <select class="select"
                            ...
                            aria-label="E-Mail-Abgleichmodus"
                            style="width:9rem">
                        <option value="0"{if $active_filter_admemail_match == '0'} selected{/if}>Genaue Übereinstimmung</option>
                        <option value="1"{if $active_filter_admemail_match != '0'} selected{/if}>Teilweise Übereinstimmung</option>
                    </select>
                </div>
            </div>
        {/if}
        ...
        <div class="grid gap-3" style="grid-template-columns:12rem 1fr;align-items:end">
            <label class="label" for="search-admins-webgroup">Web-Gruppe</label>
            <div class="flex gap-2" style="flex-wrap:wrap">
                <select class="select"
        ...
        <div class="grid gap-3" style="grid-template-columns:12rem 1fr;align-items:end">
            <label class="label" for="search-admins-srvadmgroup">SourceMod-Administratorgruppe</label>
            <div class="flex gap-2" style="flex-wrap:wrap">
                <select class="select"
        ...
        <div class="grid gap-3" style="grid-template-columns:12rem 1fr;align-items:end">
            <label class="label" for="search-admins-srvgroup">Servergruppe</label>
            <div class="flex gap-2" style="flex-wrap:wrap">
                <select class="select"
        ...
        <div class="grid gap-3" style="grid-template-columns:12rem 1fr;align-items:end">
            <label class="label" for="search-admins-admwebflag">Web-Berechtigungen</label>
            <div class="flex gap-2" style="flex-wrap:wrap">
                <select class="select"
        ...
        <div class="grid gap-3" style="grid-template-columns:12rem 1fr;align-items:end">
            <label class="label" for="search-admins-admsrvflag">Server-Berechtigungen</label>
            <div class="flex gap-2" style="flex-wrap:wrap">
                <select class="select"
                ...
                <select class="select"
                    ...
                    {foreach from=$server_list item="server"}
                        <option value="{$server.sid}"
                                ...
                                data-server-host{if $active_filter_server == $server.sid && $active_filter_server != ''} selected{/if}>Laden&hellip; ({$server.ip}:{$server.port})</option>
                    {/foreach}
                </select>
            </div>
        </div>
        ...
        <div class="flex gap-2 justify-end" style="border-top:1px solid var(--border);padding-top:0.75rem">
            <a class="btn btn--ghost btn--sm"
               ...
               data-testid="search-admins-reset">Filter löschen</a>
            <button type="submit"
