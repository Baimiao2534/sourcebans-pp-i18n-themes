...
<form method="get"
    ...
    <div class="card__body space-y-3">
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <div>
                <label class="label" for="search-log-admin">管理员</label>
                <select class="select"
                        id="search-log-admin"
            ...
            <div class="text-xs text-muted">选择一个管理员以筛选该账户的操作。</div>
            <button type="submit"
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <label class="label" for="search-log-message" style="grid-column:1;align-self:end">消息</label>
            <input class="input"
                   id="search-log-message"
                   type="text"
                   placeholder="对日志消息进行子字符串匹配&hellip;"
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <span class="label" style="grid-column:1;align-self:end">日期范围</span>
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                ...
                <input class="input font-mono" style="width:4.25rem" type="text" maxlength="4" placeholder="YYYY"
                       ...
                       inputmode="numeric"
                       pattern="[0-9]*">
                <span class="text-muted text-xs" style="margin-left:0.5rem">从</span>
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <div>
                <label class="label" for="search-log-type">类型</label>
                <select class="select"
                        id="search-log-type"
                        data-testid="search-log-type">
                    <option value="m">消息</option>
                    <option value="w">警告</option>
                    <option value="e">错误</option>
                </select>
            </div>
            <div class="text-xs text-muted">筛选为单一严重程度。</div>
            <button type="submit"
                    class="btn btn--secondary btn--sm"
