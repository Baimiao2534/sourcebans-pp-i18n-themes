...
{if NOT $permission_add}
    <div class="card">
        <div class="card__body">
            <p class="text-muted">Zugriff verweigert.</p>
        </div>
    </div>
{else}
    <form method="post"
        ...
        <div class="card">
            <div class="card__header">
                <div>
                    <h3>Mod hinzufügen</h3>
                    <p>Konfigurieren Sie einen neuen Spiel-Mod, der Banns und Servern zugewiesen werden kann.</p>
                </div>
            </div>
            <div class="card__body space-y-4" style="max-width:42rem">
                ...
                <div>
                    <label class="label" for="folder">Mod-Ordner</label>
                    <input class="input"
                           type="text"
                           id="folder"
                           name="folder"
                    ...
                    <p class="text-xs text-muted" style="margin-top:0.25rem">
                        Ordnername auf dem Datenträger (z. B. <span class="font-mono">cstrike</span> für Counter-Strike: Source).
                    </p>
                    <div id="folder.msg"
                         class="text-xs"
                         style="color:var(--danger);display:none;margin-top:0.25rem"></div>
                ...
                <div>
                    <label class="label" for="steam_universe">Steam-Universe-Nummer</label>
                    <input class="input"
                           type="number"
                           id="steam_universe"
                           name="steam_universe"
                    ...
                    <p class="text-xs text-muted" style="margin-top:0.25rem">
                        Erste Ziffer (X) von <span class="font-mono">STEAM_X:Y:Z</span>, wie von diesem Mod gerendert. Standard 0.
                    </p>
                </div>
                ...
                <div>
                    <label class="flex items-center gap-2">
                        <input type="checkbox"
                               ...
                               value="1"
                               checked>
                        <span class="text-sm">Aktiviert — kann Banns und Servern zugewiesen werden.</span>
                    </label>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-xs text-muted" data-testid="addmod-current-icon" hidden>
                            Aktuell: <span class="font-mono" data-testid="addmod-current-icon-name"></span>
                        </span>
                    </div>
                    <p class="text-xs text-muted" style="margin-top:0.25rem">
                        16x16 GIF, PNG oder JPG. Öffnet einen Popup-Uploader.
                    </p>
                    <div id="icon.msg"
                         class="text-xs"
                ...
                <div class="flex justify-end gap-2"
                    ...
                    <a class="btn btn--ghost btn--sm"
                       ...
                       data-testid="addmod-cancel">Zurück</a>
    ...
    (function () {
        ...
        document.addEventListener('submit', function (e) {
            ...
            var errors = 0;
            if (!name)   { showMsg('name.msg',   'Sie müssen einen Namen für den Mod eingeben.'); errors++; }
            if (!folder) { showMsg('folder.msg', "Sie müssen den Ordnernamen des Mods eingeben."); errors++; }
            if (!icon)   { showMsg('icon.msg',   'Sie müssen ein Icon für den Mod hochladen.'); errors++; }
            if (errors > 0) return;
            ...
            if (!a || !A) {
                ...
                showMsg('name.msg', 'JSON-Dispatcher fehlt. Aktualisieren Sie die Seite und versuchen Sie es erneut.');
                return;
            }
            ...
            a.call(A.ModsAdd, {
                ...
                if (r.ok === false) {
                    ...
                    var slot = field === 'folder' ? 'folder.msg'
                        ...
                        : 'name.msg';
                    showMsg(slot, em);
                    toast('error', 'Mod hinzufügen fehlgeschlagen', em);
                    return;
                }
                var data = r.data || {};
                var msg = data.message || {};
                toast('success', msg.title || 'Mod hinzugefügt', msg.body || 'Der Mod wurde hinzugefügt.');
                ...
                toast('error', 'Mod hinzufügen fehlgeschlagen', String(err && err.message ? err.message : err));
            });
        });
    })();
    </script>
