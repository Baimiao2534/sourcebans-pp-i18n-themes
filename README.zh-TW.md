...
[SourceBans++](https://github.com/sbpp/sourcebans-pp) 2.0.0+ 網面板板的多語言（i18n）主題包。每個主題都是預設主題的完整本地化替代版本，在 Smarty 模板層進行翻譯，無需修改任何 PHP 檔案。
...
2. 解壓縮後會得到每種語言對應的資料夾（如 `zh_TW`、`ja_JP`）。
