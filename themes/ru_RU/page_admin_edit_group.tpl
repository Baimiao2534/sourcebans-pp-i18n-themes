...
<div class="space-y-4" data-testid="admin-edit-group">
    <div class="mb-4">
        ...
        <p class="text-sm text-muted m-0 mt-2">
            {if $type === 'srv'}Серверная группа: флаги администратора SourceMod + покомандные переопределения.
            {else}Веб-группа: права внутри панели.{/if}
        </p>
    </div>
    ...
    <form id="edit-group-form" class="space-y-4" autocomplete="off"
        ...
        <div class="card">
            ...
            <div class="card__body">
                <label class="label" for="groupname">Название группы</label>
                ...
                <div class="card__body">
                    <table class="table" style="margin:0;font-size:var(--fs-sm)">
                        ...
                        <tbody>
                            ...
                            {/if}
                            <tr><td><strong>Управление администраторами</strong></td>
                            ...
                            <tr><td><strong>Управление серверами</strong></td>
                            ...
                            <tr><td><strong>Управление банами</strong></td>
                            ...
                            <tr><td><strong>Управление группами</strong></td>
                            ...
                            <tr><td><strong>Уведомления на email</strong></td>
                            ...
                            <tr><td><strong>Настройки веб-панели</strong></td>
                                <td class="text-center"><input type="checkbox" id="p26" {if $web_settings}checked{/if}></td></tr>

                            <tr><td><strong>Управление модами</strong></td>
        ...
        {else}
            ...
            <div class="card">
                <div class="card__header"><div>
                    <h3>Переопределения группы</h3>
                    <p>
                        Переопределения группы позволяют полностью разрешить или запретить определённые команды
                        или группы команд для участников группы. Подробнее о
                        <a href="http://wiki.alliedmods.net/Adding_Groups_%28SourceMod%29" target="_blank" rel="noopener noreferrer">переопределениях группы</a>
                        в вики AlliedModders.
                    </p>
                    <p class="text-sm text-muted m-0 mt-2">
                        Очистка имени переопределения приведёт к его удалению.
                    </p>
                </div></div>
                <div class="card__body">
                    <table class="table" style="margin:0;font-size:var(--fs-sm)" id="overrides-table">
                        ...
                        <tbody data-overrides-body>
                                ...
                                <tr data-override-row data-override-id="{$override.id}">
                                    <td>
                                        <select class="input" data-override-field="type">
                                            <option value="command" {if $override.type === 'command'}selected{/if}>Команда</option>
                                            <option value="group"   {if $override.type === 'group'}selected{/if}>Группа</option>
                                        </select>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <select class="input" data-override-field="access">
                                            <option value="allow" {if $override.access === 'allow'}selected{/if}>Разрешить</option>
                                            <option value="deny"  {if $override.access === 'deny'}selected{/if}>Запретить</option>
                                        </select>
                                    </td>
                                </tr>
                            {/foreach}
                            <tr data-override-new>
                                ...
                                <td><input class="input" type="text" id="new_override_name" placeholder="(пусто = без нового переопределения)"></td>
                                <td>
        ...
        <div class="flex gap-2">
            <button type="submit" class="btn btn--primary"
                    data-testid="admin-edit-group-save">Сохранить изменения</button>
            <a class="btn btn--ghost" href="index.php?p=admin&amp;c=groups">Отмена</a>
        </div>
    </form>
</div>
