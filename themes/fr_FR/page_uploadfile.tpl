...
<div class="card" style="max-width:24rem;margin:0 auto">
    <div class="card__header">
        <div>
            <h3>{$title}</h3>
            <p>Choisissez un fichier à téléverser. Le fichier doit être au format {$formats}.</p>
        </div>
    </div>
    <div class="card__body">
        ...
        <form action=""
            ...
            <label class="label" for="uploadfile-input">Sélectionner un fichier</label>
...
(function () {
    document.addEventListener('change', function (e) {
        ...
        span.textContent = f ? f.name : 'Aucun fichier choisi';
    });
})();
</script>
</body>
