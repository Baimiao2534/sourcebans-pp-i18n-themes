        ...
        <div class="flex items-center justify-between gap-4 mb-4" style="flex-wrap:wrap">
            <div>
                ...
                <p class="text-sm text-muted m-0 mt-2">
                    Bannissements signalés par les joueurs en attente de révision par un administrateur.
                </p>
            </div>
        ...
        {if $submission_list|@count == 0}
            ...
            <div class="card" data-testid="submissions-empty">
                <div class="empty-state">
                    ...
                    <h2 class="empty-state__title">Aucun signalement en attente</h2>
                    <p class="empty-state__body">La file est vide. Les bannissements signalés par les joueurs apparaîtront ici pour révision lorsqu&rsquo;ils seront soumis.</p>
                </div>
            </div>
        {else}
    ...
    document.addEventListener('click', function (e) {
        ...
        if (act === 'submission-archive') {
            ...
            a2.call(A2.SubmissionsRemove, { sid: sid, archiv: '1' }).then(function (r) {
                ...
                toast('success', 'Signalement archivé', 'Restaurable depuis la page des signalements archivés si nécessaire.');
            });
        }
    });
})();
