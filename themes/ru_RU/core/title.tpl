...
<div class="main">
    <header class="topbar" data-testid="topbar">
        ...
        <nav class="topbar__breadcrumbs" aria-label="Хлебные крошки">
        ...
        *}
        <button type="button"
                ...
                aria-label="Открыть палитру команд (поиск игроков, SteamID, страниц)">
            <i data-lucide="search" style="width:14px;height:14px"></i>
            <span class="topbar__search-label">Поиск игроков, SteamID…</span>
