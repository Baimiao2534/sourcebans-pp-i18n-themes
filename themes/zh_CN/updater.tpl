...
<div class="p-6 space-y-6" style="max-width:48rem;margin:2.5rem auto;width:100%">
    ...
    <header class="flex items-center gap-3" data-testid="updater-header">
        ...
        <div>
            ...
            <p class="text-sm text-muted m-0 mt-2">数据库迁移日志。</p>
        </div>
    </header>
    ...
    <section class="card">
        ...
        <div class="card__body">
            ...
            {else}
                <p class="text-sm text-muted m-0" data-testid="updater-empty">未应用任何更新。</p>
            {/if}
        </div>
    </section>
    ...
    <section class="card">
        <div class="card__header" data-testid="updater-cleanup">
            <div>
                <h3>下一步</h3>
                <p>运行完成后，请在向管理员开放面板之前删除 <code class="font-mono">/updater</code> 目录。</p>
            </div>
        </div>
        <div class="card__body">
