...
<section class="admin-home">
    <header class="admin-home__header mb-6">
        <h1 class="admin-home__title">Panneau d&rsquo;administration</h1>
        <p class="admin-home__subtitle text-sm text-muted mt-2">Gérez les administrateurs, groupes, serveurs et paramètres du panneau.</p>
    </header>

    <ul class="admin-cards" role="list" aria-label="Zones d&rsquo;administration">
        {if $can_admins}
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-admins">
                    ...
                    <div class="admin-card__title">Administrateurs</div>
                    <div class="admin-card__desc">Consulter, ajouter, modifier et supprimer les administrateurs du panneau.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-groups">
                    ...
                    <div class="admin-card__title">Groupes</div>
                    <div class="admin-card__desc">Regroupements de permissions et d&rsquo;immunité pour les administrateurs.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-servers">
                    ...
                    <div class="admin-card__title">Serveurs</div>
                    <div class="admin-card__desc">Les serveurs de jeu auxquels SourceBans++ se connecte.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-bans">
                    ...
                    <div class="admin-card__title">Bannissements</div>
                    <div class="admin-card__desc">Ajouter des bannissements, examiner les signalements et les appels.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-mods">
                    ...
                    <div class="admin-card__desc">Entrées de jeu/mod affichées dans tout le panneau.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                ...
                <a class="admin-card"
                   ...
                   data-testid="admin-card-overrides">
                    ...
                    <div class="admin-card__title">Remplacements</div>
                    <div class="admin-card__desc">Remplacer les droits de commande SourceMod par serveur ou par groupe.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-settings">
                    ...
                    <div class="admin-card__title">Paramètres</div>
                    <div class="admin-card__desc">Configuration SMTP, thème et intégrations.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-audit">
                    ...
                    <div class="admin-card__title">Journal d&rsquo;audit</div>
                    <div class="admin-card__desc">Actions des administrateurs sur l&rsquo;ensemble du panneau.</div>
                </a>
            </li>
        {/if}
    </ul>
