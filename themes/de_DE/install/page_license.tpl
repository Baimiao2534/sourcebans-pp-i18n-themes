...
<p class="lead">
    Sie müssen die untenstehende Lizenz akzeptieren, um das Panel zu installieren.
    Der vollständige Text befindet sich auf
    <a href="https://www.elastic.co/licensing/elastic-license"
       target="_blank" rel="noopener">elastic.co/licensing/elastic-license</a>;
    die mit dieser Installation mitgelieferten SourceMod-Plugins sind separat unter
    <a href="https://www.gnu.org/licenses/gpl-3.0.html"
       target="_blank" rel="noopener">GPLv3</a> lizenziert.
</p>
...
<form method="post"
    ...
    <label class="flex items-center gap-2"
        ...
        <input type="checkbox"
               ...
               required>
        <span>Ich habe die obenstehende Lizenz gelesen und akzeptiere sie.</span>
    </label>
