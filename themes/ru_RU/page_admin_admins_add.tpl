    ...
    {if !$can_add_admins}
        <div class="card">
            <div class="card__body">
                <p class="text-sm text-muted m-0">Доступ запрещён.</p>
            </div>
        </div>
    {else}
        <div class="mb-4">
            <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">Добавить нового администратора</h1>
            <p class="text-sm text-muted m-0 mt-2">Наведите курсор на значки справки для получения подсказок по полям.</p>
        </div>
        ...
        <div id="msg-green" class="card" style="display:none;border-left:3px solid var(--success)">
            <div class="card__body">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="font-semibold">Администратор добавлен</div>
                        <div class="text-sm text-muted">Новый администратор успешно добавлен. Перенаправление&hellip;</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form id="add-admin-form" method="post" action="" class="space-y-4" autocomplete="off">
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>Идентификация</h3>
                        <p>Логин и Steam ID идентифицируют этого администратора в панели и на игровых серверах.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                        <div>
                            <label class="label" for="adminname">Логин администратора</label>
                    ...
                    <div>
                        <label class="label" for="email">Эл. почта <span class="text-faint" style="font-weight:400">(обязательно для веб-доступа)</span></label>
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        ...
                        <p>Пароль для веб-панели и необязательный пароль администратора в игре.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                        <div>
                            <label class="label" for="password">Пароль <span class="text-faint" style="font-weight:400">(обязательно для веб-доступа)</span></label>
                            <div class="flex gap-2">
                                ...
                                <button type="button" class="btn btn--ghost btn--icon"
                                        ...
                                        aria-label="Сгенерировать случайный пароль"
                        ...
                        <div>
                            <label class="label" for="password2">Подтвердите пароль</label>
                    ...
                    <div class="flex items-center gap-2 mt-2" style="border-top:1px solid var(--border);padding-top:0.75rem">
                        ...
                        <label for="a_useserverpass" class="text-sm font-medium" style="margin:0">Установить пароль администратора в игре</label>
                        <input class="input" id="a_serverpass" name="a_serverpass" type="password"
                               ...
                               aria-label="Пароль администратора в игре">
                    </div>
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>Доступ к серверам</h3>
                        <p>Серверы и группы серверов, которые администратор сможет модерировать в игре.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    {if !$group_list && !$server_list}
                        <p class="text-sm text-muted m-0"><em>Серверы и группы серверов ещё не добавлены.</em></p>
                    {else}
                        {if $group_list}
                            <div class="text-xs text-faint" style="text-transform:uppercase;letter-spacing:0.06em;font-weight:600">Группы серверов</div>
                        ...
                        {/if}
                        {if $server_list}
                            <div class="text-xs text-faint" style="text-transform:uppercase;letter-spacing:0.06em;font-weight:600;margin-top:0.5rem">Отдельные серверы</div>
                            {*
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>Права доступа</h3>
                        <p>Готовые группы, пользовательские флаги или без прав. Выбор новой группы открывает встроенный редактор.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    <div>
                        <label class="label" for="serverg">Группа серверного администратора</label>
                        ...
                        <select class="select" id="serverg" name="serverg" tabindex="8"
                            ...
                            <option value="-2">Выберите&hellip;</option>
                            <option value="-3">Без прав</option>
                            <option value="c">Пользовательские права</option>
                        ...
                        <div id="serverperm" style="overflow:hidden">
                            <div id="server-new-name-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="server-new-name">Название новой группы серверных администраторов</label>
                            ...
                            <div id="server-flags-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="server-flags">Флаги SourceMod и иммунитет</label>
                                <input class="input font-mono" id="server-flags" name="server-flags" type="text"
                                       ...
                                       placeholder="напр. abz#50">
                                <p class="text-xs text-muted m-0 mt-2">
                                    Строка флагов SourceMod. Добавьте <code>#&lt;иммунитет&gt;</code> для иммунитета (по умолчанию 0).
                                </p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <label class="label" for="webg">Группа веб-администратора</label>
                        ...
                        <div id="webperm" style="overflow:hidden">
                            <div id="web-new-name-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="web-new-name">Название новой группы веб-администраторов</label>
                            ...
                            <div id="web-flags-block" hidden style="margin-top:0.75rem">
                                <fieldset style="border:1px solid var(--border);border-radius:var(--radius-md);padding:0.75rem">
                                    <legend class="text-xs text-faint" style="padding:0 0.5rem;text-transform:uppercase;letter-spacing:0.06em;font-weight:600">Веб-права</legend>
                                    <p class="text-xs text-muted m-0 mb-2">Выберите флаги, которые имеет этот администратор (или новая группа). Владелец предоставляет все остальные флаги.</p>
                                    <div class="grid gap-2" style="grid-template-columns:repeat(auto-fill,minmax(16rem,1fr))">
                                        ...
                                        {if $can_grant_owner}
                                            {* #1402 adversarial review HIGH 1: OWNER is gated.
                                               ...
                                               affordance half. *}
                                            <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_OWNER" data-testid="admin-add-flag-owner"> <span class="text-sm">Владелец</span></label>
                                        {/if}
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_ADMINS"> <span class="text-sm">Просмотр администраторов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_ADMINS"> <span class="text-sm">Добавление администраторов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_ADMINS"> <span class="text-sm">Редактирование администраторов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_ADMINS"> <span class="text-sm">Удаление администраторов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_SERVERS"> <span class="text-sm">Просмотр серверов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_SERVER"> <span class="text-sm">Добавление серверов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_SERVERS"> <span class="text-sm">Редактирование серверов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_SERVERS"> <span class="text-sm">Удаление серверов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_BAN"> <span class="text-sm">Добавление банов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_OWN_BANS"> <span class="text-sm">Редактирование своих банов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_GROUP_BANS"> <span class="text-sm">Редактирование групповых банов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_ALL_BANS"> <span class="text-sm">Редактирование всех банов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_UNBAN"> <span class="text-sm">Разбан всех банов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_UNBAN_OWN_BANS"> <span class="text-sm">Разбан своих банов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_UNBAN_GROUP_BANS"> <span class="text-sm">Разбан групповых банов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_BAN"> <span class="text-sm">Удаление всех банов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_PROTESTS"> <span class="text-sm">Апелляции на баны</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_SUBMISSIONS"> <span class="text-sm">Жалобы на баны</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_IMPORT"> <span class="text-sm">Импорт банов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_GROUPS"> <span class="text-sm">Просмотр групп</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_GROUP"> <span class="text-sm">Добавление групп</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_GROUPS"> <span class="text-sm">Редактирование групп</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_GROUPS"> <span class="text-sm">Удаление групп</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_WEB_SETTINGS"> <span class="text-sm">Веб-настройки</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_MODS"> <span class="text-sm">Просмотр модов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_MODS"> <span class="text-sm">Добавление модов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_MODS"> <span class="text-sm">Редактирование модов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_MODS"> <span class="text-sm">Удаление модов</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_NOTIFY_SUB"> <span class="text-sm">Email-уведомления о жалобах</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_NOTIFY_PROTEST"> <span class="text-sm">Email-уведомления об апелляциях</span></label>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
            ...
            <div class="flex justify-end gap-2">
                <button type="button" class="btn btn--ghost btn--sm"
                        onclick="history.go(-1);" data-testid="admin-add-back">Назад</button>
                <button type="submit" class="btn btn--primary btn--sm" id="aadmin"
                        data-testid="admin-add-submit"><i data-lucide="user-plus"></i> Добавить администратора</button>
            </div>
        </form>
            ...
            document.addEventListener('submit', function (e) {
                ...
                a.call(A.AdminsAdd, {
                    ...
                    if (r.ok === false) {
                        ...
                        showMsg(slot, em);
                        toast('error', 'Не удалось добавить администратора', em);
                        return;
                    }
                    var data = r.data || {};
                    var msg = data.message || {};
                    toast('success', msg.title || 'Администратор добавлен', msg.body || 'Администратор добавлен.');
                    ...
                    setBusy(submitBtn, false);
                    toast('error', 'Не удалось добавить администратора', String(err && err.message ? err.message : err));
                });
            });
