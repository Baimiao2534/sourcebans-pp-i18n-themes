...
<section class="admin-home">
    <header class="admin-home__header mb-6">
        <h1 class="admin-home__title">Панель администратора</h1>
        <p class="admin-home__subtitle text-sm text-muted mt-2">Управление администраторами, группами, серверами и настройками панели.</p>
    </header>

    <ul class="admin-cards" role="list" aria-label="Разделы администратора">
        {if $can_admins}
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-admins">
                    ...
                    <div class="admin-card__title">Администраторы</div>
                    <div class="admin-card__desc">Просмотр, добавление, изменение и удаление администраторов панели.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-groups">
                    ...
                    <div class="admin-card__title">Группы</div>
                    <div class="admin-card__desc">Группировки прав и иммунитета для администраторов.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-servers">
                    ...
                    <div class="admin-card__title">Серверы</div>
                    <div class="admin-card__desc">Игровые серверы, с которыми взаимодействует SourceBans++.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-bans">
                    ...
                    <div class="admin-card__title">Баны</div>
                    <div class="admin-card__desc">Добавление банов, рассмотрение заявок и апелляций.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-mods">
                    ...
                    <div class="admin-card__title">Моды</div>
                    <div class="admin-card__desc">Записи игр/модов, отображаемые в панели.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                ...
                <a class="admin-card"
                   ...
                   data-testid="admin-card-overrides">
                    ...
                    <div class="admin-card__title">Оверрайды</div>
                    <div class="admin-card__desc">Переопределение флагов команд SourceMod для сервера или группы.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-settings">
                    ...
                    <div class="admin-card__desc">Конфигурация SMTP, тем и интеграций.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-audit">
                    ...
                    <div class="admin-card__title">Журнал аудита</div>
                    <div class="admin-card__desc">Действия администраторов в панели.</div>
                </a>
            </li>
        {/if}
    </ul>
