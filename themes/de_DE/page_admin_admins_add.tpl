    ...
    {if !$can_add_admins}
        <div class="card">
            <div class="card__body">
                <p class="text-sm text-muted m-0">Zugriff verweigert.</p>
            </div>
        </div>
    {else}
        <div class="mb-4">
            <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">Neuen Administrator hinzufügen</h1>
            <p class="text-sm text-muted m-0 mt-2">Bewegen Sie den Mauszeiger über die Hilfesymbole für feldspezifische Hinweise.</p>
        </div>
        ...
        <div id="msg-green" class="card" style="display:none;border-left:3px solid var(--success)">
            <div class="card__body">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="font-semibold">Administrator hinzugefügt</div>
                        <div class="text-sm text-muted">Der neue Administrator wurde erfolgreich hinzugefügt. Weiterleitung&hellip;</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form id="add-admin-form" method="post" action="" class="space-y-4" autocomplete="off">
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>Identität</h3>
                        <p>Anmeldename und Steam-ID identifizieren diesen Administrator im Panel und auf Gameservern.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                        <div>
                            <label class="label" for="adminname">Administrator-Anmeldung</label>
                    ...
                    <div>
                        <label class="label" for="email">E-Mail <span class="text-faint" style="font-weight:400">(für Web-Zugriff erforderlich)</span></label>
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        ...
                        <p>Web-Panel-Passwort und optionales In-Game-Admin-Passwort.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                        <div>
                            <label class="label" for="password">Passwort <span class="text-faint" style="font-weight:400">(für Web-Zugriff erforderlich)</span></label>
                        ...
                        <div>
                            <label class="label" for="password2">Passwort bestätigen</label>
                    ...
                    <div class="flex items-center gap-2 mt-2" style="border-top:1px solid var(--border);padding-top:0.75rem">
                        ...
                        <label for="a_useserverpass" class="text-sm font-medium" style="margin:0">In-Game-Admin-Passwort festlegen</label>
                        <input class="input" id="a_serverpass" name="a_serverpass" type="password"
                               ...
                               aria-label="In-Game-Admin-Passwort">
                    </div>
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>Serverzugriff</h3>
                        <p>Server und Servergruppen, die der Administrator im Spiel verwalten kann.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    {if !$group_list && !$server_list}
                        <p class="text-sm text-muted m-0"><em>Noch keine Server oder Servergruppen hinzugefügt.</em></p>
                    {else}
                        {if $group_list}
                            <div class="text-xs text-faint" style="text-transform:uppercase;letter-spacing:0.06em;font-weight:600">Servergruppen</div>
                        ...
                        {/if}
                        {if $server_list}
                            <div class="text-xs text-faint" style="text-transform:uppercase;letter-spacing:0.06em;font-weight:600;margin-top:0.5rem">Einzelne Server</div>
                            {*
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        ...
                        <p>Vorgefertigte Gruppen, benutzerdefinierte Flags oder keine Berechtigungen. „Neue Gruppe" öffnet einen Inline-Editor.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    <div>
                        <label class="label" for="serverg">Server-Administratorgruppe</label>
                        ...
                        <select class="select" id="serverg" name="serverg" tabindex="8"
                            ...
                            <option value="-2">Bitte auswählen&hellip;</option>
                            <option value="-3">Keine Berechtigungen</option>
                            <option value="c">Benutzerdefinierte Berechtigungen</option>
                            <option value="n">Neue Administratorgruppe</option>
                            <optgroup label="Gruppen" style="font-weight:bold">
                        ...
                        <div id="serverperm" style="overflow:hidden">
                            <div id="server-new-name-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="server-new-name">Name der neuen Server-Administratorgruppe</label>
                            ...
                            <div id="server-flags-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="server-flags">SourceMod-Flags &amp; Immunität</label>
                                <input class="input font-mono" id="server-flags" name="server-flags" type="text"
                                       ...
                                       placeholder="z. B. abz#50">
                                <p class="text-xs text-muted m-0 mt-2">
                                    SourceMod-Flag-String. Hängen Sie <code>#&lt;immunität&gt;</code> für Immunität an (Standardwert 0).
                                </p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <label class="label" for="webg">Web-Administratorgruppe</label>
                        ...
                        <div id="webperm" style="overflow:hidden">
                            <div id="web-new-name-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="web-new-name">Name der neuen Web-Administratorgruppe</label>
                            ...
                            <div id="web-flags-block" hidden style="margin-top:0.75rem">
                                <fieldset style="border:1px solid var(--border);border-radius:var(--radius-md);padding:0.75rem">
                                    <legend class="text-xs text-faint" style="padding:0 0.5rem;text-transform:uppercase;letter-spacing:0.06em;font-weight:600">Web-Berechtigungen</legend>
                                    <p class="text-xs text-muted m-0 mb-2">Wählen Sie die Flags, die dieser Administrator (oder die neue Gruppe) hält. Owner vergibt alle anderen Flags.</p>
                                    <div class="grid gap-2" style="grid-template-columns:repeat(auto-fill,minmax(16rem,1fr))">
                                        ...
                                        {/if}
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_ADMINS"> <span class="text-sm">Administratoren ansehen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_ADMINS"> <span class="text-sm">Administratoren hinzufügen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_ADMINS"> <span class="text-sm">Administratoren bearbeiten</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_ADMINS"> <span class="text-sm">Administratoren löschen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_SERVERS"> <span class="text-sm">Server ansehen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_SERVER"> <span class="text-sm">Server hinzufügen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_SERVERS"> <span class="text-sm">Server bearbeiten</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_SERVERS"> <span class="text-sm">Server löschen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_BAN"> <span class="text-sm">Banns hinzufügen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_OWN_BANS"> <span class="text-sm">Eigene Banns bearbeiten</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_GROUP_BANS"> <span class="text-sm">Gruppen-Banns bearbeiten</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_ALL_BANS"> <span class="text-sm">Alle Banns bearbeiten</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_UNBAN"> <span class="text-sm">Alle Banns aufheben</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_UNBAN_OWN_BANS"> <span class="text-sm">Eigene Banns aufheben</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_UNBAN_GROUP_BANS"> <span class="text-sm">Gruppen-Banns aufheben</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_BAN"> <span class="text-sm">Alle Banns löschen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_PROTESTS"> <span class="text-sm">Bann-Einsprüche</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_SUBMISSIONS"> <span class="text-sm">Bann-Meldungen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_IMPORT"> <span class="text-sm">Banns importieren</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_GROUPS"> <span class="text-sm">Gruppen ansehen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_GROUP"> <span class="text-sm">Gruppen hinzufügen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_GROUPS"> <span class="text-sm">Gruppen bearbeiten</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_GROUPS"> <span class="text-sm">Gruppen löschen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_WEB_SETTINGS"> <span class="text-sm">Web-Einstellungen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_MODS"> <span class="text-sm">Mods ansehen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_MODS"> <span class="text-sm">Mods hinzufügen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_MODS"> <span class="text-sm">Mods bearbeiten</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_MODS"> <span class="text-sm">Mods löschen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_NOTIFY_SUB"> <span class="text-sm">E-Mail-Benachrichtigungen für Bann-Meldungen</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_NOTIFY_PROTEST"> <span class="text-sm">E-Mail-Benachrichtigungen für Bann-Einsprüche</span></label>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
            ...
            <div class="flex justify-end gap-2">
                <button type="button" class="btn btn--ghost btn--sm"
                        onclick="history.go(-1);" data-testid="admin-add-back">Zurück</button>
                <button type="submit" class="btn btn--primary btn--sm" id="aadmin"
                        data-testid="admin-add-submit"><i data-lucide="user-plus"></i> Administrator hinzufügen</button>
            </div>
        </form>
        ...
        (function () {
            ...
            document.addEventListener('click', function (e) {
                ...
                a.call(A.AdminsGeneratePassword, {}).then(function (r) {
                    ...
                    setBusy(btn, false);
                    toast('error', 'Passwortgenerierung fehlgeschlagen', String(err && err.message ? err.message : err));
                });
            });
            ...
            document.addEventListener('submit', function (e) {
                ...
                a.call(A.AdminsAdd, {
                    ...
                    if (r.ok === false) {
                        ...
                        var em = (r.error && r.error.message) || 'Unbekannter Fehler';
                        ...
                        showMsg(slot, em);
                        toast('error', 'Hinzufügen fehlgeschlagen', em);
                        return;
                    }
                    var data = r.data || {};
                    var msg = data.message || {};
                    toast('success', msg.title || 'Administrator hinzugefügt', msg.body || 'Der Administrator wurde hinzugefügt.');
                    ...
                    setBusy(submitBtn, false);
                    toast('error', 'Hinzufügen fehlgeschlagen', String(err && err.message ? err.message : err));
                });
            });
