...
<div class="card-tab page-section" id="Edit Admin Server Access">
    <div class="mb-4">
        <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">Accès aux serveurs de l'administrateur</h1>
        <p class="text-sm text-muted m-0 mt-2">Choisissez les serveurs et groupes de serveurs que cet administrateur peut gérer en jeu.</p>
    </div>
    ...
    {if $row_count < 1}
        <div class="card">
            <div class="card__body">
                <p class="text-sm text-muted m-0"><em>Vous devez ajouter un serveur ou un groupe de serveurs avant de pouvoir configurer les permissions serveur de l'administrateur.</em></p>
            </div>
        </div>
    {else}
        <form method="post" action="" class="space-y-4">
                ...
                <div class="card">
                    <div class="card__header">
                        <div>
                            ...
                            <p>Accorder un groupe couvre tous les serveurs de ce groupe.</p>
                        </div>
                    </div>
                    <div class="card__body">
            ...
            {if $server_list}
                <div class="card">
                    <div class="card__header">
                        <div>
                            <h3>Serveurs individuels</h3>
                            <p>Accès ponctuel pour les serveurs qui ne font pas partie d'un groupe accordé.</p>
                        </div>
                    </div>
                    <div class="card__body">
            ...
            <div class="flex justify-end gap-2">
                ...
                <button type="submit" class="btn btn--primary btn--sm" id="editadminserver"
                        data-testid="edit-admin-servers-save"><i data-lucide="save"></i> Enregistrer les modifications</button>
            </div>
        </form>
    {/if}
</div>
