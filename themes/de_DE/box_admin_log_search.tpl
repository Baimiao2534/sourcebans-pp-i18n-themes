...
<form method="get"
    ...
    <div class="card__header">
        <div>
            ...
            <p>Filtern Sie das Systemprotokoll nach Administrator, Nachrichtentext, Zeitraum oder Schweregrad.</p>
        </div>
    </div>
    ...
    <div class="card__body space-y-3">
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <div>
                <label class="label" for="search-log-admin">Administrator</label>
                <select class="select"
                        id="search-log-admin"
            ...
            <div class="text-xs text-muted">Wählen Sie einen Administrator, um Aktionen auf dieses Konto zu filtern.</div>
            <button type="submit"
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <label class="label" for="search-log-message" style="grid-column:1;align-self:end">Nachricht</label>
            <input class="input"
                   id="search-log-message"
                   type="text"
                   placeholder="Teilzeichenfolge zum Abgleich mit der Protokollnachricht&hellip;"
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <span class="label" style="grid-column:1;align-self:end">Zeitraum</span>
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                ...
                <input class="input font-mono" style="width:4.25rem" type="text" maxlength="4" placeholder="YYYY"
                       ...
                       inputmode="numeric"
                       pattern="[0-9]*">
                <span class="text-muted text-xs" style="margin-left:0.5rem">von</span>
                ...
                <input class="input font-mono" style="width:3rem" type="text" maxlength="2" value="00"
                       ...
                       inputmode="numeric"
                       pattern="[0-9]*">
                <span class="text-muted text-xs" style="margin-left:0.5rem">bis</span>
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <div>
                <label class="label" for="search-log-type">Typ</label>
                <select class="select"
                        id="search-log-type"
                        data-testid="search-log-type">
                    <option value="m">Nachricht</option>
                    <option value="w">Warnung</option>
                    <option value="e">Fehler</option>
                </select>
            </div>
            <div class="text-xs text-muted">Auf einen einzelnen Schweregrad filtern.</div>
            <button type="submit"
                    class="btn btn--secondary btn--sm"
