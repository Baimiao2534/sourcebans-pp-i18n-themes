...
{if NOT $can_edit_ban}
    <div class="card" data-testid="editban-denied">
        <div class="card__body">
            ...
            <p class="text-sm text-muted m-0 mt-2">您没有权限编辑此封禁。</p>
        </div>
    </div>
{else}
    <section class="p-6" data-testid="editban-section" style="max-width:48rem">
        <div class="mb-6">
            <h1 style="font-size:1.5rem;font-weight:600;margin:0">编辑封禁</h1>
        ...
        <form id="editban-form"
            ...
            <div>
                <label class="label" for="name">玩家名称</label>
                <input type="text"
                       class="input"
                       id="name"
                       name="name"
                ...
                <div>
                    ...
                    <select class="select"
                        ...
                        <optgroup label="月">
                            ...
                            <option value="86400">2个月</option>
                            <option value="129600">3个月</option>
                            <option value="259200">6个月</option>
                            <option value="518400">12个月</option>
                        </optgroup>
                    </select>
                    <div class="text-xs mt-2"
                         id="length.msg"
            ...
            <div>
                <label class="label" for="steam">Steam ID / 社区ID</label>
                <input type="text"
                       ...
                       title="请输入 Steam ID (STEAM_0:1:23498765)、Steam3 ID ([U:1:23498765]) 或17位 SteamID64。">
                <div class="text-xs mt-2"
                     id="steam.msg"
                     style="color:var(--danger);display:none"></div>
            </div>
            ...
            <div>
                <label class="label" for="ip">IP地址</label>
                <input type="text"
                       class="input font-mono"
                       id="ip"
                       name="ip"
            ...
            <div data-ban-id="{$ban_id}" data-testid="editban-demo-section">
                <label class="label">Demo上传</label>
