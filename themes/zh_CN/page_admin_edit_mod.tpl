        ...
        <div class="card__body space-y-4" style="max-width:42rem">
            ...
            <div>
                ...
                <p class="text-xs text-muted" style="margin-top:0.25rem">
                    磁盘上的文件夹名称（例如 Counter-Strike: Source 的 <span class="font-mono">cstrike</span>）。
                </p>
                <div id="folder.msg"
                     class="text-xs"
                     style="color:var(--danger);display:none;margin-top:0.25rem"></div>
            ...
            <div>
                ...
                <p class="text-xs text-muted" style="margin-top:0.25rem">
                    此模组渲染的 <span class="font-mono">STEAM_X:Y:Z</span> 中的第一位数字 (X)。
                </p>
            </div>
            ...
            <div class="flex justify-end gap-2"
                ...
                <a class="btn btn--ghost btn--sm"
                   ...
                   data-testid="editmod-cancel">返回</a>
