        ...
        <div class="flex items-center justify-between gap-4 mb-4" style="flex-wrap:wrap">
            <div>
                ...
                <p class="text-sm text-muted m-0 mt-2">
                    Von Spielern gemeldete Banns, die auf Überprüfung durch einen Administrator warten.
                </p>
            </div>
        ...
        {if $submission_list|@count == 0}
            ...
            <div class="card" data-testid="submissions-empty">
                <div class="empty-state">
                    ...
                    <h2 class="empty-state__title">Keine ausstehenden Einreichungen</h2>
                    <p class="empty-state__body">Die Warteschlange ist leer. Von Spielern gemeldete Banns erscheinen hier zur Überprüfung, sobald sie eingereicht werden.</p>
                </div>
            </div>
        {else}
                            ...
                            <div class="row-actions">
                                ...
                                {if $permissions_editsub}
                                    <button type="button"
                                            ...
                                            data-archiv="1">
                                        <span data-confirm-label>Entfernen</span>
                                    </button>
                                {/if}
...
(function () {
    ...
    function arm(btn) {
        ...
        labelEl.textContent = 'Zum Bestätigen klicken';
        btn.setAttribute('data-pending', 'true');
        btn.setAttribute('aria-label', 'Erneut innerhalb von 3 Sekunden klicken, um die Entfernung zu bestätigen');
    ...
    document.addEventListener('click', function (e) {
        ...
        if (act === 'submission-archive') {
            ...
            toast('success', 'Einreichung archiviert', 'Bei Bedarf über die Seite für archivierte Einreichungen wiederherstellen.');
            });
        }
    });
})();
