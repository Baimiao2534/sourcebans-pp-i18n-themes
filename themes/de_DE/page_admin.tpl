...
<section class="admin-home">
    <header class="admin-home__header mb-6">
        <h1 class="admin-home__title">Verwaltungspanel</h1>
        <p class="admin-home__subtitle text-sm text-muted mt-2">Administratoren, Gruppen, Server und Panel-Einstellungen verwalten.</p>
    </header>

    <ul class="admin-cards" role="list" aria-label="Verwaltungsabschnitte">
        {if $can_admins}
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-admins">
                    ...
                    <div class="admin-card__title">Administratoren</div>
                    <div class="admin-card__desc">Administratoren ansehen, hinzufügen, bearbeiten und entfernen.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-groups">
                    ...
                    <div class="admin-card__title">Gruppen</div>
                    <div class="admin-card__desc">Berechtigungs- und Immunitätsgruppen für Administratoren.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-servers">
                    ...
                    <div class="admin-card__title">Server</div>
                    <div class="admin-card__desc">Gameserver, mit denen SourceBans++ kommuniziert.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-bans">
                    ...
                    <div class="admin-card__title">Banns</div>
                    <div class="admin-card__desc">Banns hinzufügen, Einreichungen und Einsprüche prüfen.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-mods">
                    ...
                    <div class="admin-card__desc">Spiel-/Mod-Einträge im gesamten Panel.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                ...
                <a class="admin-card"
                   ...
                   data-testid="admin-card-overrides">
                    ...
                    <div class="admin-card__desc">SourceMod-Befehls-Flags pro Server oder Gruppe überschreiben.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-settings">
                    ...
                    <div class="admin-card__title">Einstellungen</div>
                    <div class="admin-card__desc">SMTP-, Theme- und Integrationskonfiguration.</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-audit">
                    ...
                    <div class="admin-card__title">Audit-Protokoll</div>
                    <div class="admin-card__desc">Administratoren-Aktionen im gesamten Panel.</div>
                </a>
            </li>
        {/if}
    </ul>
