...
<aside class="admin-sidebar"
       ...
       aria-label="{if $sidebar_label == 'Admin sections'}Verwaltungsabschnitte{elseif $sidebar_label == 'Bans sections'}Bann-Abschnitte{elseif $sidebar_label == 'Group sections'}Gruppen-Abschnitte{elseif $sidebar_label == 'MOD sections'}Mod-Abschnitte{elseif $sidebar_label == 'Server sections'}Server-Abschnitte{elseif $sidebar_label == 'Settings sections'}Einstellungs-Abschnitte{elseif $sidebar_label == 'Page sections'}Seiten-Abschnitte{else}{$sidebar_label}{/if}">
    <details class="admin-sidebar__details" open>
        <summary class="admin-sidebar__summary">
            <span class="admin-sidebar__summary-label">
                ...
                {if $sidebar_label == 'Admin sections'}Verwaltungsabschnitte{elseif $sidebar_label == 'Bans sections'}Bann-Abschnitte{elseif $sidebar_label == 'Group sections'}Gruppen-Abschnitte{elseif $sidebar_label == 'MOD sections'}Mod-Abschnitte{elseif $sidebar_label == 'Server sections'}Server-Abschnitte{elseif $sidebar_label == 'Settings sections'}Einstellungs-Abschnitte{elseif $sidebar_label == 'Page sections'}Seiten-Abschnitte{else}{$sidebar_label}{/if}
            </span>
            <i data-lucide="chevron-down" class="admin-sidebar__chevron" style="width:14px;height:14px"></i>
        </summary>
        <nav class="admin-sidebar__nav" aria-label="{if $sidebar_label == 'Admin sections'}Verwaltungsabschnitte{elseif $sidebar_label == 'Bans sections'}Bann-Abschnitte{elseif $sidebar_label == 'Group sections'}Gruppen-Abschnitte{elseif $sidebar_label == 'MOD sections'}Mod-Abschnitte{elseif $sidebar_label == 'Server sections'}Server-Abschnitte{elseif $sidebar_label == 'Settings sections'}Einstellungs-Abschnitte{elseif $sidebar_label == 'Page sections'}Seiten-Abschnitte{else}{$sidebar_label}{/if}">
            {foreach from=$tabs item=tab}
                <a class="sidebar__link admin-sidebar__link"
                   ...
                   {if $tab.slug == $active_tab}aria-current="page"{/if}>
                    ...
                    <span>{if $tab.name == 'Admins list'}Administratorenliste{elseif $tab.name == 'Add admin'}Administrator hinzufügen{elseif $tab.name == 'Add ban'}Bann hinzufügen{elseif $tab.name == 'Ban protests'}Bann-Einsprüche{elseif $tab.name == 'Ban submissions'}Bann-Einreichungen{elseif $tab.name == 'Import bans'}Banns importieren{elseif $tab.name == 'Groups'}Gruppen{elseif $tab.name == 'Groups list'}Gruppenliste{elseif $tab.name == 'Add group'}Gruppe hinzufügen{elseif $tab.name == 'Mods list'}Mod-Liste{elseif $tab.name == 'Add mod'}Mod hinzufügen{elseif $tab.name == 'Server list'}Serverliste{elseif $tab.name == 'Add server'}Server hinzufügen{elseif $tab.name == 'Server admins'}Server-Administratoren{elseif $tab.name == 'Settings'}Einstellungen{elseif $tab.name == 'Features'}Funktionen{elseif $tab.name == 'Logs'}Protokolle{elseif $tab.name == 'Themes'}Themes{elseif $tab.name == 'Add comms block'}Kommunikationsblock hinzufügen{else}{$tab.name}{/if}</span>
                </a>
            {/foreach}
        </nav>
    </details>
