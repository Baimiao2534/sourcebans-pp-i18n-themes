        ...
        {if $protest_list|@count == 0}
            ...
            <div class="card" data-testid="protests-empty">
                <div class="empty-state">
                    ...
                    <h2 class="empty-state__title">アクティブな申し立てはありません</h2>
                    <p class="empty-state__body">レビュー待ちの項目はありません。プレイヤーが新しい BAN 申し立てを送信すると、ここに表示されます。</p>
                </div>
            </div>
        {else}
...
(function () {
    ...
    document.addEventListener('click', function (e) {
        ...
        a.call(A.ProtestsRemove, { pid: pid, archiv: '1' }).then(function (r) {
            ...
            toast('success', '申し立てをアーカイブしました', '必要に応じてアーカイブ済み申し立てページから復元できます。');
        });
    });
})();
</script>
