...
<aside class="admin-sidebar"
       ...
       aria-label="{if $sidebar_label == 'Admin sections'}Sections d'administration{elseif $sidebar_label == 'Bans sections'}Sections des bannissements{elseif $sidebar_label == 'Group sections'}Sections des groupes{elseif $sidebar_label == 'MOD sections'}Sections des modules{elseif $sidebar_label == 'Server sections'}Sections des serveurs{elseif $sidebar_label == 'Settings sections'}Sections des paramètres{elseif $sidebar_label == 'Page sections'}Sections de la page{else}{$sidebar_label}{/if}">
    <details class="admin-sidebar__details" open>
        <summary class="admin-sidebar__summary">
            <span class="admin-sidebar__summary-label">
                ...
                {if $sidebar_label == 'Admin sections'}Sections d'administration{elseif $sidebar_label == 'Bans sections'}Sections des bannissements{elseif $sidebar_label == 'Group sections'}Sections des groupes{elseif $sidebar_label == 'MOD sections'}Sections des modules{elseif $sidebar_label == 'Server sections'}Sections des serveurs{elseif $sidebar_label == 'Settings sections'}Sections des paramètres{elseif $sidebar_label == 'Page sections'}Sections de la page{else}{$sidebar_label}{/if}
            </span>
            <i data-lucide="chevron-down" class="admin-sidebar__chevron" style="width:14px;height:14px"></i>
        </summary>
        <nav class="admin-sidebar__nav" aria-label="{if $sidebar_label == 'Admin sections'}Sections d'administration{elseif $sidebar_label == 'Bans sections'}Sections des bannissements{elseif $sidebar_label == 'Group sections'}Sections des groupes{elseif $sidebar_label == 'MOD sections'}Sections des modules{elseif $sidebar_label == 'Server sections'}Sections des serveurs{elseif $sidebar_label == 'Settings sections'}Sections des paramètres{elseif $sidebar_label == 'Page sections'}Sections de la page{else}{$sidebar_label}{/if}">
            {foreach from=$tabs item=tab}
                <a class="sidebar__link admin-sidebar__link"
                   ...
                   {if $tab.slug == $active_tab}aria-current="page"{/if}>
                    ...
                    <span>{if $tab.name == 'Admins list'}Liste des administrateurs{elseif $tab.name == 'Add admin'}Ajouter un administrateur{elseif $tab.name == 'Add ban'}Ajouter un bannissement{elseif $tab.name == 'Ban protests'}Contestations de bannissement{elseif $tab.name == 'Ban submissions'}Signalements de bannissement{elseif $tab.name == 'Import bans'}Importer des bannissements{elseif $tab.name == 'Groups'}Groupes{elseif $tab.name == 'Groups list'}Liste des groupes{elseif $tab.name == 'Add group'}Ajouter un groupe{elseif $tab.name == 'Mods list'}Liste des modules{elseif $tab.name == 'Add mod'}Ajouter un module{elseif $tab.name == 'Server list'}Liste des serveurs{elseif $tab.name == 'Add server'}Ajouter un serveur{elseif $tab.name == 'Server admins'}Administrateurs du serveur{elseif $tab.name == 'Settings'}Paramètres{elseif $tab.name == 'Features'}Fonctionnalités{elseif $tab.name == 'Logs'}Journaux{elseif $tab.name == 'Themes'}Thèmes{elseif $tab.name == 'Add comms block'}Ajouter un blocage communication{else}{$tab.name}{/if}</span>
                </a>
            {/foreach}
        </nav>
    </details>
