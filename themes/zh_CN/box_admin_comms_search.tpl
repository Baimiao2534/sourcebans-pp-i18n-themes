...
<form method="get"
    ...
    <div class="card__body space-y-3">
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <label class="label" for="search-comms-name" style="grid-column:1;align-self:end">昵称</label>
            <input class="input"
        ...
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <label class="label" for="search-comms-btype">类型</label>
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                <select class="select"
        ...
        {if NOT $hideadminname}
            <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
                <label class="label" for="search-comms-admin">管理员</label>
                <div class="flex items-center gap-2" style="flex-wrap:wrap">
                    <select class="select"
        ...
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <label class="label" for="search-comms-server">服务器</label>
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                <select class="select"
        ...
        {if $is_admin}
            <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
                <label class="label" for="search-comms-comment" style="grid-column:1;align-self:end">备注</label>
                <input class="input"
