...
<form method="post"
    ...
    <div class="card">
        <div class="card__header">
            <div>
                <h3>Modifier le mod</h3>
                <p>Mettez à jour la configuration de ce mod de jeu.</p>
            </div>
        </div>
        <div class="card__body space-y-4" style="max-width:42rem">
            ...
            <div>
                ...
                <p class="text-xs text-muted" style="margin-top:0.25rem">
                    Nom du dossier sur le disque (par ex. <span class="font-mono">cstrike</span> pour Counter-Strike: Source).
                </p>
                <div id="folder.msg"
                     class="text-xs"
                     style="color:var(--danger);display:none;margin-top:0.25rem"></div>
            ...
            <div>
                ...
                <p class="text-xs text-muted" style="margin-top:0.25rem">
                    Premier chiffre (X) de <span class="font-mono">STEAM_X:Y:Z</span> tel que rendu par ce mod.
                </p>
            </div>
            ...
            <div>
                <label class="flex items-center gap-2">
                    ...
                    <span class="text-sm">Activé — attribuable aux bannissements et aux serveurs.</span>
                </label>
            </div>
            ...
            <div class="flex justify-end gap-2"
                ...
                <a class="btn btn--ghost btn--sm"
                   ...
                   data-testid="editmod-cancel">Retour</a>
