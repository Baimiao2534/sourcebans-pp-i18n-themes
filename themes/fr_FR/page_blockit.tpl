                ...
                <tr data-testid="blockit-row--{$serv.num}-">
                    ...
                    <td>
                        <div id="srv_-{$serv.num}-"
                             ...
                             data-testid="blockit-status--{$serv.num}-">En attente&hellip;</div>
                    </td>
                </tr>
                -{/foreach}-
            </tbody>
            ...
            sb.api.call(Actions.BlockitBlockPlayer, { check: CHECK, sid: sid, num: num, type: TYPE, length: LENGTH })
                .then(function (r) {
                    ...
                    if (d.status === 'no_connect') {
                        ...
                        sb.setHTML('srv_' + num, "<span class='text-xs font-semibold' style='color:var(--success)'><u>Joueur trouvé et bloqué !</u></span>");
                        setCounter(-1);
                    } else {
