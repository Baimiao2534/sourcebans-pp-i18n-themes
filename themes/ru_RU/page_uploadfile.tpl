...
<div class="card" style="max-width:24rem;margin:0 auto">
    <div class="card__header">
        <div>
            <h3>{$title}</h3>
            <p>Выберите файл для загрузки. Файл должен быть в формате {$formats}.</p>
        </div>
    </div>
    <div class="card__body">
        ...
        <form action=""
            ...
            <label class="label" for="uploadfile-input">Выберите файл</label>
...
(function () {
    document.addEventListener('change', function (e) {
        ...
        span.textContent = f ? f.name : 'Файл не выбран';
    });
})();
</script>
</body>
