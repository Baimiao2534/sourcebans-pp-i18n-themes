...
{if NOT $permission_import}
    <div class="card" data-testid="banimport-denied">
        <div class="card__body">
            ...
            <p class="text-sm text-muted m-0 mt-2">Sie haben keine Berechtigung, Banns zu importieren.</p>
        </div>
    </div>
{else}
    <section class="p-6" data-testid="banimport-section" style="max-width:48rem">
        <div class="mb-6">
            <h1 style="font-size:1.5rem;font-weight:600;margin:0">Banns importieren</h1>
            <p class="text-sm text-muted m-0 mt-2">
                Laden Sie eine <code class="font-mono">banned_user.cfg</code>- oder
                <code class="font-mono">banned_ip.cfg</code>-Datei hoch, um vorhandene
                Banns in SourceBans zu importieren.
            </p>
        </div>
        <form id="banimport-form"
            ...
            <div>
                <label class="label" for="importFile">Bann-Datei</label>
            ...
            <label class="flex items-center gap-2 p-2"
                ...
                <div>
                    <span class="text-sm font-medium">Spielernamen über Steam Community auflösen</span>
                    <div class="text-xs text-muted">
                        {if $extreq}
                            Ruft jede Community-ID beim Import online ab
                            (funktioniert nur mit <code class="font-mono">banned_user.cfg</code>).
                        {else}
                            Deaktiviert, weil <code class="font-mono">allow_url_fopen</code>
                            auf diesem Server nicht verfügbar ist.
                        {/if}
                    </div>
                </div>
            </label>
