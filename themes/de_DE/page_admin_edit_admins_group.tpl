...
<div class="card-tab page-section" id="Edit Admin Groups">
    <div class="mb-4">
        <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">Administrator bearbeiten · {$group_admin_name|escape}</h1>
        <p class="text-sm text-muted m-0 mt-2"><strong>{$group_admin_name|escape}</strong> zwischen Web- und Server-Administratorgruppen verschieben.</p>
    </div>
    ...
    <form method="post" action="" class="space-y-4">
        ...
        <div class="card">
            <div class="card__header">
                <div>
                    <h3>Web-Administratorgruppe</h3>
                    <p>Gruppe, die den Zugriff auf das Web-Panel steuert.</p>
                </div>
            </div>
            <div class="card__body">
                <label class="label" for="wg">Web-Administratorgruppe</label>
        ...
        <div class="card">
            <div class="card__header">
                <div>
                    <h3>Server-Administratorgruppe</h3>
                    <p>SourceMod-Gruppe, die die In-Game-Administratorberechtigungen steuert.</p>
                </div>
            </div>
            <div class="card__body">
                <label class="label" for="sg">Server-Administratorgruppe</label>
        ...
        <div class="flex justify-end gap-2">
            ...
            <button type="submit" class="btn btn--primary btn--sm" id="agroups"
                    data-testid="edit-admin-group-save"><i data-lucide="save"></i> Änderungen speichern</button>
        </div>
    </form>
</div>
