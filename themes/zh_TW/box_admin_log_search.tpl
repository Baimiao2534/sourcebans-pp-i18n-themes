...
<form method="get"
    ...
    <div class="card__body space-y-3">
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <div>
                <label class="label" for="search-log-admin">管理員</label>
                <select class="select"
                        id="search-log-admin"
            ...
            <div class="text-xs text-muted">選擇管理員以篩選該帳戶的操作。</div>
            <button type="submit"
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <label class="label" for="search-log-message" style="grid-column:1;align-self:end">訊息</label>
            <input class="input"
                   id="search-log-message"
                   type="text"
                   placeholder="與日誌訊息進行子字串比對&hellip;"
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <span class="label" style="grid-column:1;align-self:end">日期範圍</span>
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                ...
                <input class="input font-mono" style="width:4.25rem" type="text" maxlength="4" placeholder="YYYY"
                       ...
                       inputmode="numeric"
                       pattern="[0-9]*">
                <span class="text-muted text-xs" style="margin-left:0.5rem">從</span>
                ...
                <input class="input font-mono" style="width:3rem" type="text" maxlength="2" value="00"
                       ...
                       inputmode="numeric"
                       pattern="[0-9]*">
                <span class="text-muted text-xs" style="margin-left:0.5rem">到</span>
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <div>
                <label class="label" for="search-log-type">類型</label>
                <select class="select"
                        id="search-log-type"
                        data-testid="search-log-type">
                    <option value="m">訊息</option>
                    <option value="w">警告</option>
                    <option value="e">錯誤</option>
                </select>
            </div>
            <div class="text-xs text-muted">篩選至單一嚴重程度。</div>
            <button type="submit"
                    class="btn btn--secondary btn--sm"
