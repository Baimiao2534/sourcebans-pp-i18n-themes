...
<section class="p-6" data-testid="banemail-section" style="max-width:48rem">
    <div class="mb-6">
        <h1 style="font-size:1.5rem;font-weight:600;margin:0">Spieler anschreiben</h1>
        <p class="text-sm text-muted m-0 mt-2">
            Empfänger: <span class="font-mono" data-testid="banemail-addr">{$email_addr|escape}</span>.
        </p>
    </div>
    <form class="card p-6 space-y-4"
        ...
        <div>
            ...
            <textarea class="textarea"
                      ...
                      name="message"
                      rows="8"
                      placeholder="Was möchten Sie dem Spieler mitteilen?"
        ...
        <div class="flex justify-end gap-2"
            ...
            <button type="button"
                    ...
                    data-testid="banemail-back">Zurück</button>
...
(function () {
    ...
    window.CheckEmail = function (type, id) {
        ...
        if (!subject || !subject.value) { setMsg('subject.msg', 'Sie müssen einen Betreff für die E-Mail eingeben.'); err++; }
        else { setMsg('subject.msg', ''); }
        if (!message || !message.value) { setMsg('message.msg', 'Sie müssen eine Nachricht für die E-Mail eingeben.'); err++; }
        ...
        a.call(A.SystemSendMail, {
            ...
            if (!r || r.ok === false) {
                toast('error', 'E-Mail fehlgeschlagen', (r && r.error && r.error.message) || 'Unbekannter Fehler');
                return;
            }
            ...
            toast('success', (msg && msg.title) || 'E-Mail gesendet', (msg && msg.body) || 'Die E-Mail wurde gesendet.');
            if (msg && msg.redir) {
