...
<section class="p-6 space-y-6" style="max-width:64rem">
    <header>
        <h1 style="font-size:1.5rem;font-weight:600;margin:0">Подать апелляцию на бан</h1>
        <p class="text-sm text-muted m-0 mt-2">
            Считаете, что бан вашего аккаунта — ошибка? Подайте апелляцию ниже, и команда модераторов её рассмотрит. Сначала проверьте бан в <a href="index.php?p=banlist" style="color:var(--accent)">списке банов</a>.
        </p>
    </header>
    ...
    <div class="grid gap-4" style="grid-template-columns:minmax(0,2fr) minmax(0,1fr)">
        <form class="card"
            ...
            <div class="card__header">
                <div>
                    <h3>Ваши данные</h3>
                    <p>Поля, отмеченные <span style="color:var(--danger)">*</span>, обязательны.</p>
                </div>
            ...
            <div class="card__body space-y-4">
                ...
                <div>
                    <label class="label" for="protest-type">Тип бана</label>
                    <select id="protest-type"
                        ...
                        <option value="1" {if $ip_first}selected{/if}>IP-адрес</option>
                    </select>
                </div>

                <div data-protest-row="steam" {if $ip_first}hidden{/if}>
                    <label class="label" for="protest-steam">
                        Ваш SteamID <span style="color:var(--danger)">*</span>
                    </label>
                ...
                <div data-protest-row="ip" {if !$ip_first}hidden{/if}>
                    <label class="label" for="protest-ip">
                        Ваш IP <span style="color:var(--danger)">*</span>
                    </label>
                    <input id="protest-ip"
                           type="text"
                           name="IP"
                ...
                <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                    <div>
                        <label class="label" for="protest-name">
                            Игровой ник <span style="color:var(--danger)">*</span>
                        </label>
                    ...
                    <div>
                        <label class="label" for="protest-email">
                            Ваш email <span style="color:var(--danger)">*</span>
                        </label>
                ...
                <div>
                    <label class="label" for="protest-reason">
                        Почему вас следует разбанить? <span style="color:var(--danger)">*</span>
                    </label>
                    <textarea id="protest-reason"
                              ...
                              placeholder="Опишите максимально подробно. Чем больше контента предоставит персонал, тем быстрее рассмотрят вашу апелляцию.">{$reason|escape}</textarea>
                </div>
            </div>
            <div class="card__header" style="justify-content:flex-end;border-top:1px solid var(--border);border-bottom:0">
                <button type="submit"
                    ...
                    <i data-lucide="send-horizontal"></i> Отправить апелляцию
                </button>
            </div>
        </form>
        ...
        <aside class="card">
            ...
            <div class="card__body space-y-4 text-sm">
                <p class="m-0 text-muted">
                    Команда модераторов получает уведомление сразу после отправки. Она изучит первоначальные доказательства бана и контекст, который вы указали здесь.
                </p>
                <p class="m-0 text-muted">
                    Ответ придёт на электронную почту — обычно в течение <span class="font-medium" style="color:var(--text)">24 часов</span>.
                </p>
                <div class="space-y-3"
                    ...
                    <div class="flex gap-2 items-start">
                        ...
                        <p class="m-0 text-xs text-muted">
                            Угрозы, преследование или оскорбления в адрес персонала не приведут к разбану и могут привести к перманентному бану во всех сервисах.
                        </p>
                    </div>
                </div>
            </div>
