...
<p class="lead">
    创建第一个管理员账户。该账户将获得
    <strong>Owner</strong> 权限标志，可执行面板中的所有操作，
    包括创建其他管理员。
</p>
...
<form method="post"
    ...
    <div class="install-section">
        ...
        <div class="install-grid">
            <div>
                <label class="label" for="install-admin-uname">用户名</label>
                <input class="input"
            ...
            <div>
                <label class="label" for="install-admin-email">邮箱</label>
                <input class="input"
            ...
            <div>
                <label class="label" for="install-admin-pass1">密码</label>
                <input class="input"
                       ...
                       required>
                <p class="text-xs text-muted">至少 8 个字符。</p>
            </div>

            <div>
                <label class="label" for="install-admin-pass2">确认密码</label>
                <input class="input"
            ...
            <div style="grid-column:1/-1">
                ...
                <p class="text-xs text-muted">
                    SteamID 格式为 <code>STEAM_0:X:NNNNNNN</code>。
                    如果您有自定义 URL 或 SteamID64，可使用
