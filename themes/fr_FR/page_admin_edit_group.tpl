...
<div class="space-y-4" data-testid="admin-edit-group">
    <div class="mb-4">
        ...
        <p class="text-sm text-muted m-0 mt-2">
            {if $type === 'srv'}Groupe serveur : flags d'administrateur SourceMod + remplacements par commande.
            {else}Groupe web : permissions du panneau.{/if}
        </p>
    </div>
    ...
    <form id="edit-group-form" class="space-y-4" autocomplete="off"
                ...
                <div class="card__body">
                    <table class="table" style="margin:0;font-size:var(--fs-sm)">
                        ...
                        <tbody>
                            ...
                            {/if}
                            <tr><td><strong>Gérer les administrateurs</strong></td>
                            ...
                            <tr><td><strong>Gestion des serveurs</strong></td>
                            ...
                            <tr><td><strong>Gestion des bannissements</strong></td>
                            ...
                            <tr><td><strong>Gestion des groupes</strong></td>
                            ...
                            <tr><td><strong>Notifications par e-mail</strong></td>
                            ...
                            <tr><td><strong>Paramètres du panneau web</strong></td>
                                <td class="text-center"><input type="checkbox" id="p26" {if $web_settings}checked{/if}></td></tr>

                            <tr><td><strong>Gérer les mods</strong></td>
        ...
        {else}
            ...
            <div class="card">
                <div class="card__header"><div>
                    <h3>Remplacements de groupe</h3>
                    <p>
                        Les remplacements de groupe permettent d&rsquo;autoriser ou de refuser complètement des commandes
                        spécifiques ou des groupes de commandes aux membres du groupe. Lisez la documentation sur les
                        <a href="http://wiki.alliedmods.net/Adding_Groups_%28SourceMod%29" target="_blank" rel="noopener noreferrer">remplacements de groupe</a>
                        dans le wiki AlliedModders.
                    </p>
                    <p class="text-sm text-muted m-0 mt-2">
                        Vider le nom d&rsquo;un remplacement le supprimera.
                    </p>
                </div></div>
                <div class="card__body">
                    <table class="table" style="margin:0;font-size:var(--fs-sm)" id="overrides-table">
                        ...
                        <tbody data-overrides-body>
                                ...
                                <tr data-override-row data-override-id="{$override.id}">
                                    <td>
                                        <select class="input" data-override-field="type">
                                            <option value="command" {if $override.type === 'command'}selected{/if}>Commande</option>
                                            <option value="group"   {if $override.type === 'group'}selected{/if}>Groupe</option>
                                        </select>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <select class="input" data-override-field="access">
                                            <option value="allow" {if $override.access === 'allow'}selected{/if}>Autoriser</option>
                                            <option value="deny"  {if $override.access === 'deny'}selected{/if}>Refuser</option>
                                        </select>
                                    </td>
                                </tr>
                            {/foreach}
                            <tr data-override-new>
                                ...
                                <td><input class="input" type="text" id="new_override_name" placeholder="(vide = aucun nouveau remplacement)"></td>
                                <td>
        ...
        <div class="flex gap-2">
            <button type="submit" class="btn btn--primary"
                    data-testid="admin-edit-group-save">Enregistrer les modifications</button>
            <a class="btn btn--ghost" href="index.php?p=admin&amp;c=groups">Annuler</a>
        </div>
    </form>
</div>
