...
<div class="card-tab page-section" id="Edit Admin Groups">
    <div class="mb-4">
        <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">Изменить администратора · {$group_admin_name|escape}</h1>
        <p class="text-sm text-muted m-0 mt-2">Переместить <strong>{$group_admin_name|escape}</strong> между веб-группой и серверной группой администраторов.</p>
    </div>

    <nav class="flex gap-2 mb-4" role="tablist" aria-label="Разделы редактирования администратора">
        <a class="btn btn--ghost btn--sm" role="tab"
           href="?p=admin&c=admins&o=editdetails&id={$smarty.get.id|escape:'url'}"
           data-testid="admin-tab-details">Данные</a>
        <a class="btn btn--secondary btn--sm" role="tab" aria-current="page"
           href="?p=admin&c=admins&o=editgroup&id={$smarty.get.id|escape:'url'}"
           data-testid="admin-tab-group">Группа</a>
        <a class="btn btn--ghost btn--sm" role="tab"
           href="?p=admin&c=admins&o=editservers&id={$smarty.get.id|escape:'url'}"
           data-testid="admin-tab-servers">Серверы</a>
        <a class="btn btn--ghost btn--sm"
           href="?p=admin&c=admins&o=editpermissions&id={$smarty.get.id|escape:'url'}">Права</a>
    </nav>
    ...
    <form method="post" action="" class="space-y-4">
        ...
        <div class="card">
            <div class="card__header">
                <div>
                    <h3>Веб-группа администратора</h3>
                    <p>Группа, контролирующая доступ к веб-панели.</p>
                </div>
            </div>
            <div class="card__body">
                <label class="label" for="wg">Веб-группа администратора</label>
        ...
        <div class="card">
            <div class="card__header">
                <div>
                    <h3>Серверная группа администратора</h3>
                    <p>Группа SourceMod, контролирующая права администратора в игре.</p>
                </div>
            </div>
            <div class="card__body">
                <label class="label" for="sg">Серверная группа администратора</label>
        ...
        <div class="flex justify-end gap-2">
            ...
            <button type="submit" class="btn btn--primary btn--sm" id="agroups"
                    data-testid="edit-admin-group-save"><i data-lucide="save"></i> Сохранить изменения</button>
        </div>
    </form>
</div>
