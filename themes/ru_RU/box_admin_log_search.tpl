...
<form method="get"
    ...
    <div class="card__header">
        <div>
            ...
            <p>Фильтрация системного журнала по администратору, тексту сообщения, диапазону дат или уровню серьёзности.</p>
        </div>
    </div>
    ...
    <div class="card__body space-y-3">
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <div>
                <label class="label" for="search-log-admin">Администратор</label>
                <select class="select"
                        id="search-log-admin"
            ...
            <div class="text-xs text-muted">Выберите администратора для фильтрации действий по этому аккаунту.</div>
            <button type="submit"
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <label class="label" for="search-log-message" style="grid-column:1;align-self:end">Сообщение</label>
            <input class="input"
                   id="search-log-message"
                   type="text"
                   placeholder="Частичное совпадение с сообщением журнала&hellip;"
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <span class="label" style="grid-column:1;align-self:end">Диапазон дат</span>
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                ...
                <input class="input font-mono" style="width:4.25rem" type="text" maxlength="4" placeholder="YYYY"
                       ...
                       inputmode="numeric"
                       pattern="[0-9]*">
                <span class="text-muted text-xs" style="margin-left:0.5rem">с</span>
                ...
                <input class="input font-mono" style="width:3rem" type="text" maxlength="2" value="00"
                       ...
                       inputmode="numeric"
                       pattern="[0-9]*">
                <span class="text-muted text-xs" style="margin-left:0.5rem">до</span>
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <div>
                <label class="label" for="search-log-type">Тип</label>
                <select class="select"
                        id="search-log-type"
                        data-testid="search-log-type">
                    <option value="m">Сообщение</option>
                    <option value="w">Предупреждение</option>
                    <option value="e">Ошибка</option>
                </select>
            </div>
            <div class="text-xs text-muted">Фильтр по одному уровню серьёзности.</div>
            <button type="submit"
                    class="btn btn--secondary btn--sm"
