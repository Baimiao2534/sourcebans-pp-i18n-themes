...
<p class="lead">
    Для установки панели необходимо принять следующую лицензию.
    ...
    плагины SourceMod, поставляемые с этим установщиком, лицензируются отдельно под
    ...
    <div class="card__header">
        <div>
            <h2 style="margin:0;font-size:0.95rem;font-weight:600">
                Elastic License 2.0 (веб-панель) &middot; GPLv3 (плагины SourceMod)
            </h2>
        </div>
    </div>
...
<form method="post"
    ...
    <label class="flex items-center gap-2"
        ...
        <input type="checkbox"
               ...
               required>
        <span>Я прочитал(а) и принимаю вышеуказанную лицензию.</span>
    </label>
