        ...
        <div class="flex items-center justify-between gap-4 mb-4" style="flex-wrap:wrap">
            <div>
                ...
                <p class="text-sm text-muted m-0 mt-2">
                    Banns, bei denen Spieler um Überprüfung gebeten haben.
                </p>
            </div>
        ...
        {if $protest_list|@count == 0}
            ...
            <div class="card" data-testid="protests-empty">
                <div class="empty-state">
                    ...
                    <h2 class="empty-state__title">Keine aktiven Einsprüche</h2>
                    <p class="empty-state__body">Es steht nichts zur Überprüfung an. Neue Bann-Einsprüche erscheinen hier, sobald Spieler sie einreichen.</p>
                </div>
            </div>
        {else}
...
(function () {
    ...
    document.addEventListener('click', function (e) {
        ...
        a.call(A.ProtestsRemove, { pid: pid, archiv: '1' }).then(function (r) {
            ...
            toast('success', 'Einspruch archiviert', 'Bei Bedarf über die Seite für archivierte Einsprüche wiederherstellen.');
        });
    });
})();
</script>
