...
<section class="admin-home">
    <header class="admin-home__header mb-6">
        <h1 class="admin-home__title">管理パネル</h1>
        <p class="admin-home__subtitle text-sm text-muted mt-2">管理者、グループ、サーバー、パネル設定を管理します。</p>
    </header>

    <ul class="admin-cards" role="list" aria-label="管理エリア">
        {if $can_admins}
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-admins">
                    ...
                    <div class="admin-card__title">管理者</div>
                    <div class="admin-card__desc">パネル管理者の表示、追加、編集、削除。</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-groups">
                    ...
                    <div class="admin-card__title">グループ</div>
                    <div class="admin-card__desc">管理者の権限と免疫グループ。</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-servers">
                    ...
                    <div class="admin-card__title">サーバー</div>
                    <div class="admin-card__desc">SourceBans++ が通信するゲームサーバー。</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-bans">
                    ...
                    <div class="admin-card__title">BAN</div>
                    <div class="admin-card__desc">BAN の追加、申し立てと異議申し立ての審査。</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-mods">
                    ...
                    <div class="admin-card__title">MOD</div>
                    <div class="admin-card__desc">パネル全体に表示されるゲーム / MOD エントリ。</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                ...
                <a class="admin-card"
                   ...
                   data-testid="admin-card-overrides">
                    ...
                    <div class="admin-card__title">オーバーライド</div>
                    <div class="admin-card__desc">サーバーまたはグループごとに SourceMod コマンドフラグをオーバーライド。</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-settings">
                    ...
                    <div class="admin-card__desc">SMTP、テーマ、統合設定。</div>
                </a>
            </li>
        {/if}
            ...
            <li>
                <a class="admin-card"
                   ...
                   data-testid="admin-card-audit">
                    ...
                    <div class="admin-card__title">監査ログ</div>
                    <div class="admin-card__desc">パネル全体の管理者操作。</div>
                </a>
            </li>
        {/if}
    </ul>
