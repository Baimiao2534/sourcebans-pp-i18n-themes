...
<head>
 ...
 <title>Aktualisierer | SourceBans++</title>
 <script>
 (function () {
 try {
...
<div class="p-6 space-y-6" style="max-width:48rem;margin:2.5rem auto;width:100%">
    ...
    <header class="flex items-center gap-3" data-testid="updater-header">
        ...
        <div>
            <h1 style="font-size:var(--fs-2xl);font-weight:600;margin:0">SourceBans++-Aktualisierer</h1>
            <p class="text-sm text-muted m-0 mt-2">Datenbank-Migrationsprotokoll.</p>
        </div>
    </header>
    ...
    <section class="card">
        <div class="card__header" data-testid="updater-progress">
            <div>
                <h3>Fortschritt</h3>
                <p>Jede Zeile unten ist ein Schritt des Migrations-Runners.</p>
            </div>
        </div>
        <div class="card__body">
            ...
            {else}
                <p class="text-sm text-muted m-0" data-testid="updater-empty">Es wurden keine Aktualisierungen angewendet.</p>
            {/if}
        </div>
    </section>
    ...
    <section class="card">
        <div class="card__header" data-testid="updater-cleanup">
            <div>
                ...
                <p>Entfernen Sie nach Abschluss des Durchlaufs das Verzeichnis <code class="font-mono">/updater</code>, bevor Sie das Panel den Administratoren zur Verfügung stellen.</p>
            </div>
        </div>
        <div class="card__body">
