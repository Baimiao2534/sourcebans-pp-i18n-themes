...
<p class="lead">
    Erstellen Sie das erste Administratorkonto. Dieses Konto erhält das
    <strong>Owner</strong>-Berechtigungsflag, das alle Aktionen im Panel
    ausführen kann, einschließlich des Erstellens weiterer Administratoren.
</p>
...
<form method="post"
    ...
    <div class="install-section">
        ...
        <div class="install-grid">
            <div>
                <label class="label" for="install-admin-uname">Benutzername</label>
                <input class="input"
            ...
            <div>
                <label class="label" for="install-admin-email">E-Mail</label>
                <input class="input"
            ...
            <div>
                <label class="label" for="install-admin-pass1">Passwort</label>
                <input class="input"
                       ...
                       required>
                <p class="text-xs text-muted">Mindestens 8 Zeichen.</p>
            </div>

            <div>
                <label class="label" for="install-admin-pass2">Passwort bestätigen</label>
                <input class="input"
            ...
            <div style="grid-column:1/-1">
                ...
                <p class="text-xs text-muted">
                    SteamID im Format <code>STEAM_0:X:NNNNNNN</code>.
                    Verwenden Sie <a href="https://steamid.io/" target="_blank" rel="noopener">steamid.io</a>,
                    wenn Sie eine Vanity-URL oder SteamID64 haben.
                </p>
            </div>
        </div>
    </div>
...
(function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        if (pass1.value !== pass2.value) {
            pass2.setCustomValidity('Die eingegebenen Passwörter stimmen nicht überein.');
