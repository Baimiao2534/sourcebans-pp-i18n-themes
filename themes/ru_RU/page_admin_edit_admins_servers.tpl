...
<div class="card-tab page-section" id="Edit Admin Server Access">
    <div class="mb-4">
        <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">Доступ администратора к серверам</h1>
        <p class="text-sm text-muted m-0 mt-2">Выберите серверы и серверные группы, которые этот администратор может администрировать в игре.</p>
    </div>
    ...
    {if $row_count < 1}
        <div class="card">
            <div class="card__body">
                <p class="text-sm text-muted m-0"><em>Перед настройкой прав администратора на серверах необходимо добавить сервер или серверную группу.</em></p>
            </div>
        </div>
    {else}
        <form method="post" action="" class="space-y-4">
            ...
            {if $group_list}
                <div class="card">
                    <div class="card__header">
                        <div>
                            <h3>Серверные группы</h3>
                            <p>Предоставление группы охватывает все серверы в этой группе.</p>
                        </div>
                    </div>
                    <div class="card__body">
            ...
            {if $server_list}
                <div class="card">
                    <div class="card__header">
                        <div>
                            <h3>Отдельные серверы</h3>
                            <p>Индивидуальный доступ для серверов, не входящих в предоставленную группу.</p>
                        </div>
                    </div>
                    <div class="card__body">
            ...
            <div class="flex justify-end gap-2">
                ...
                <button type="submit" class="btn btn--primary btn--sm" id="editadminserver"
                        data-testid="edit-admin-servers-save"><i data-lucide="save"></i> Сохранить изменения</button>
            </div>
        </form>
    {/if}
</div>
