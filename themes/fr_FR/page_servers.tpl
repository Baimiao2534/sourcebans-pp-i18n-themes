        ...
        <div>
            ...
            <p class="text-sm text-muted m-0 mt-2"
               ...
               data-total="{$server_list|@count}">
                {$server_list|@count} configuré(s)
                <span data-online-count>&middot; <span data-online-num>0</span> en ligne</span>
            </p>
        </div>
        {*
        ...
        {if $can_use_context_menu}
            ...
            <p class="text-xs text-muted m-0 servers-rcon-hint"
               ...
               style="max-width:24rem;text-align:right">
                Faites un clic droit sur un joueur dans une carte déployée
                pour consulter son profil, copier son SteamID, ou l'expulser
                / bannir / bloquer. Les actions expulser / bannir / bloquer
                n'apparaissent que sur les serveurs auxquels vous avez accès RCON.
            </p>
        {/if}
    </header>
    ...
    {if $server_list|@count == 0}
        ...
        <div class="card" data-testid="servers-empty">
            <div class="empty-state">
                ...
                <h2 class="empty-state__title">Aucun serveur configuré</h2>
                <p class="empty-state__body">
                    Une fois que vous aurez ajouté un serveur, les joueurs,
                    le statut et les compteurs en temps réel apparaîtront ici
                    pour les visiteurs.
                </p>
                {if $can_add_server}
        ...
        <article class="card"
            ...
            <div class="card__body">
                ...
                <dl class="grid gap-2 text-xs"
                    ...
                    <dt class="text-muted flex items-center gap-1" style="margin:0">
                        <i data-lucide="map" style="width:13px;height:13px"></i> Carte
                    </dt>
                    <dd class="font-mono text-faint" data-testid="server-map" style="margin:0">&mdash;</dd>

                    <dt class="text-muted flex items-center gap-1" style="margin:0">
                        <i data-lucide="users" style="width:13px;height:13px"></i> Joueurs
                    </dt>
            ...
            <div id="server-players-{$server.sid}"
                ...
                *}
                ...
                <p class="text-xs text-muted m-0" data-empty-message>Aucun joueur actuellement connecté.</p>
