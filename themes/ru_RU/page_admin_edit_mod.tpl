...
<form method="post"
    ...
    <div class="card">
        <div class="card__header">
            <div>
                <h3>Изменить мод</h3>
                <p>Обновите конфигурацию этого игрового мода.</p>
            </div>
        </div>
        <div class="card__body space-y-4" style="max-width:42rem">
            ...
            <div>
                ...
                <p class="text-xs text-muted" style="margin-top:0.25rem">
                    Первая цифра (X) из <span class="font-mono">STEAM_X:Y:Z</span>, отображаемая этим модом.
                </p>
            </div>
            ...
            <div>
                <label class="flex items-center gap-2">
                    ...
                    <span class="text-sm">Включён — доступен для банов и серверов.</span>
                </label>
            </div>
            ...
            <div class="flex justify-end gap-2"
                ...
                <a class="btn btn--ghost btn--sm"
                   ...
                   data-testid="editmod-cancel">Назад</a>
