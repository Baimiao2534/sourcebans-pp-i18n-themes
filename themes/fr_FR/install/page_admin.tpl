...
<p class="lead">
    Créez le premier compte administrateur. Ce compte reçoit le
    droit <strong>Owner</strong>, qui permet de tout faire dans
    le panneau, y compris créer d'autres administrateurs.
</p>
...
<form method="post"
    ...
    <div class="install-section">
        ...
        <div class="install-grid">
            <div>
                <label class="label" for="install-admin-uname">Nom d'utilisateur</label>
                <input class="input"
            ...
            <div>
                <label class="label" for="install-admin-pass1">Mot de passe</label>
                <input class="input"
                       ...
                       required>
                <p class="text-xs text-muted">Au moins 8 caractères.</p>
            </div>

            <div>
                <label class="label" for="install-admin-pass2">Confirmer le mot de passe</label>
                <input class="input"
            ...
            <div style="grid-column:1/-1">
                ...
                <p class="text-xs text-muted">
                    SteamID au format <code>STEAM_0:X:NNNNNNN</code>.
                    Utilisez <a href="https://steamid.io/" target="_blank" rel="noopener">steamid.io</a>
                    si vous avez une URL personnalisée ou un SteamID64.
                </p>
            </div>
        </div>
    </div>
