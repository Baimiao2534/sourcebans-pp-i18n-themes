        ...
        {if $submission_list|@count == 0}
            ...
            <div class="card" data-testid="submissions-empty">
                <div class="empty-state">
                    ...
                    <h2 class="empty-state__title">待機中の申告はありません</h2>
                    <p class="empty-state__body">キューは空です。プレイヤーからの BAN 申告は送信されるとここにレビュー対象として表示されます。</p>
                </div>
            </div>
        {else}
                            ...
                            <div class="row-actions">
                                ...
                                {if $permissions_editsub}
                                    <button type="button"
                                            ...
                                            data-archiv="1">
                                        <span data-confirm-label>削除</span>
                                    </button>
                                {/if}
...
(function () {
    ...
    function arm(btn) {
        ...
        labelEl.textContent = 'クリックで確定';
        btn.setAttribute('data-pending', 'true');
        btn.setAttribute('aria-label', '3 秒以内に再度クリックして削除を確定してください');
    ...
    document.addEventListener('click', function (e) {
        ...
        if (act === 'submission-archive') {
            ...
            a2.call(A2.SubmissionsRemove, { sid: sid, archiv: '1' }).then(function (r) {
                ...
                toast('success', '申告をアーカイブしました', '必要に応じてアーカイブ済み申告ページから復元できます。');
            });
        }
    });
})();
