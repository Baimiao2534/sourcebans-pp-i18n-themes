    ...
    {if !$can_add_admins}
        <div class="card">
            <div class="card__body">
                <p class="text-sm text-muted m-0">访问被拒绝。</p>
            </div>
        </div>
    {else}
        <div class="mb-4">
            <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">添加新管理员</h1>
            <p class="text-sm text-muted m-0 mt-2">将鼠标悬停在帮助图标上以查看字段级指引。</p>
        </div>
        ...
        <div id="msg-green" class="card" style="display:none;border-left:3px solid var(--success)">
            <div class="card__body">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="font-semibold">管理员已添加</div>
                        <div class="text-sm text-muted">新管理员已成功添加。正在跳转&hellip;</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form id="add-admin-form" method="post" action="" class="space-y-4" autocomplete="off">
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>身份</h3>
                        <p>登录名和 Steam ID 用于在面板和游戏服务器中标识此管理员。</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                        <div>
                            <label class="label" for="adminname">管理员登录名</label>
                    ...
                    <div>
                        <label class="label" for="email">邮箱 <span class="text-faint" style="font-weight:400">(网页访问必填)</span></label>
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>认证</h3>
                        <p>网页面板密码和可选的游戏内管理员密码。</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                        <div>
                            <label class="label" for="password">密码 <span class="text-faint" style="font-weight:400">(网页访问必填)</span></label>
                    ...
                    <div class="flex items-center gap-2 mt-2" style="border-top:1px solid var(--border);padding-top:0.75rem">
                        ...
                        <label for="a_useserverpass" class="text-sm font-medium" style="margin:0">设置游戏内管理员密码</label>
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>服务器访问</h3>
                        <p>管理员可在游戏内管理的服务器和服务器分组。</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    {if !$group_list && !$server_list}
                        <p class="text-sm text-muted m-0"><em>尚未添加任何服务器或服务器分组。</em></p>
                    {else}
                        {if $group_list}
                            <div class="text-xs text-faint" style="text-transform:uppercase;letter-spacing:0.06em;font-weight:600">服务器分组</div>
                        ...
                        {/if}
                        {if $server_list}
                            <div class="text-xs text-faint" style="text-transform:uppercase;letter-spacing:0.06em;font-weight:600;margin-top:0.5rem">单个服务器</div>
                            {*
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>权限</h3>
                        <p>预设分组、自定义权限标志或无权限。选择新分组会打开内联编辑器。</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    <div>
                        <label class="label" for="serverg">服务器管理员分组</label>
                        ...
                        <select class="select" id="serverg" name="serverg" tabindex="8"
                            ...
                            <option value="-2">请选择&hellip;</option>
                            <option value="-3">无权限</option>
                            <option value="c">自定义权限</option>
                            <option value="n">新建管理员分组</option>
                        ...
                        <div id="serverperm" style="overflow:hidden">
                            <div id="server-new-name-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="server-new-name">新服务器管理员分组名称</label>
                            ...
                            <div id="server-flags-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="server-flags">SourceMod 权限标志 &amp; 免疫</label>
                                ...
                                <p class="text-xs text-muted m-0 mt-2">
                                    SourceMod 权限标志字符串。追加 <code>#&lt;免疫值&gt;</code> 设置免疫（默认为 0）。
                                </p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <label class="label" for="webg">网页管理员分组</label>
                        ...
                        <div id="webperm" style="overflow:hidden">
                            <div id="web-new-name-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="web-new-name">新网页管理员分组名称</label>
                            ...
                            <div id="web-flags-block" hidden style="margin-top:0.75rem">
                                <fieldset style="border:1px solid var(--border);border-radius:var(--radius-md);padding:0.75rem">
                                    <legend class="text-xs text-faint" style="padding:0 0.5rem;text-transform:uppercase;letter-spacing:0.06em;font-weight:600">网页权限</legend>
                                    <p class="text-xs text-muted m-0 mb-2">选择此管理员（或新分组）持有的权限标志。所有者权限会授予其他所有权限。</p>
                                    <div class="grid gap-2" style="grid-template-columns:repeat(auto-fill,minmax(16rem,1fr))">
                                        ...
                                        {/if}
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_ADMINS"> <span class="text-sm">查看管理员</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_ADMINS"> <span class="text-sm">添加管理员</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_ADMINS"> <span class="text-sm">编辑管理员</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_ADMINS"> <span class="text-sm">删除管理员</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_SERVERS"> <span class="text-sm">查看服务器</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_SERVER"> <span class="text-sm">添加服务器</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_SERVERS"> <span class="text-sm">编辑服务器</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_SERVERS"> <span class="text-sm">删除服务器</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_BAN"> <span class="text-sm">添加封禁</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_OWN_BANS"> <span class="text-sm">编辑自己的封禁</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_GROUP_BANS"> <span class="text-sm">编辑同组封禁</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_ALL_BANS"> <span class="text-sm">编辑所有封禁</span></label>
                                        ...
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_UNBAN_GROUP_BANS"> <span class="text-sm">解封同组封禁</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_BAN"> <span class="text-sm">删除所有封禁</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_PROTESTS"> <span class="text-sm">封禁申诉</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_SUBMISSIONS"> <span class="text-sm">封禁举报</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_IMPORT"> <span class="text-sm">导入封禁</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_GROUPS"> <span class="text-sm">查看分组</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_GROUP"> <span class="text-sm">添加分组</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_GROUPS"> <span class="text-sm">编辑分组</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_GROUPS"> <span class="text-sm">删除分组</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_WEB_SETTINGS"> <span class="text-sm">网页设置</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_MODS"> <span class="text-sm">查看模组</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_MODS"> <span class="text-sm">添加模组</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_MODS"> <span class="text-sm">编辑模组</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_MODS"> <span class="text-sm">删除模组</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_NOTIFY_SUB"> <span class="text-sm">封禁举报邮件通知</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_NOTIFY_PROTEST"> <span class="text-sm">封禁申诉邮件通知</span></label>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
            ...
            <div class="flex justify-end gap-2">
                ...
                <button type="submit" class="btn btn--primary btn--sm" id="aadmin"
                        data-testid="admin-add-submit"><i data-lucide="user-plus"></i> 添加管理员</button>
            </div>
        </form>
        ...
        (function () {
            ...
            document.addEventListener('click', function (e) {
                ...
                a.call(A.AdminsGeneratePassword, {}).then(function (r) {
                    ...
                    setBusy(btn, false);
                    toast('error', '生成密码失败', String(err && err.message ? err.message : err));
                });
            });
            ...
            document.addEventListener('submit', function (e) {
                ...
                a.call(A.AdminsAdd, {
                    ...
                    if (r.ok === false) {
                        ...
                        showMsg(slot, em);
                        toast('error', '添加管理员失败', em);
                        return;
                    }
                    var data = r.data || {};
                    var msg = data.message || {};
                    toast('success', msg.title || '管理员已添加', msg.body || '管理员已添加。');
                    ...
                    setBusy(submitBtn, false);
                    toast('error', '添加管理员失败', String(err && err.message ? err.message : err));
                });
            });
