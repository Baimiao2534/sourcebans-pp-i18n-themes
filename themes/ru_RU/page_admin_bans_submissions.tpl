        ...
        <div class="flex items-center justify-between gap-4 mb-4" style="flex-wrap:wrap">
            <div>
                ...
                <p class="text-sm text-muted m-0 mt-2">
                    Заявки от игроков, ожидающие проверки администратором.
                </p>
            </div>
        ...
        {if $submission_list|@count == 0}
            ...
            <div class="card" data-testid="submissions-empty">
                <div class="empty-state">
                    ...
                    <h2 class="empty-state__title">Нет ожидающих заявок</h2>
                    <p class="empty-state__body">Очередь пуста. Заявки на баны от игроков будут появляться здесь для проверки после их подачи.</p>
                </div>
            </div>
        {else}
    ...
    document.addEventListener('click', function (e) {
        ...
        if (act === 'submission-archive') {
            ...
            a2.call(A2.SubmissionsRemove, { sid: sid, archiv: '1' }).then(function (r) {
                ...
                toast('success', 'Заявка архивирована', 'При необходимости восстановите её со страницы архива заявок.');
            });
        }
    });
})();
