        ...
        <div>
            ...
            <p class="text-sm text-muted m-0 mt-2"
               ...
               data-total="{$server_list|@count}">
                {$server_list|@count} 已設定
                <span data-online-count>&middot; <span data-online-num>0</span> 上線</span>
            </p>
        </div>
        {*
        ...
        {if $can_use_context_menu}
            ...
            <p class="text-xs text-muted m-0 servers-rcon-hint"
               ...
               style="max-width:24rem;text-align:right">
                在展開的卡片上對玩家點擊右鍵，可檢視其個人檔案、
                複製 SteamID，或對其進行踢出 / 封禁 / 通訊封禁。
                踢出 / 封禁 / 通訊封禁操作僅在您擁有 RCON 權限的伺服器上顯示。
            </p>
        {/if}
    </header>
    ...
    {if $server_list|@count == 0}
        ...
        <div class="card" data-testid="servers-empty">
            <div class="empty-state">
                ...
                <h2 class="empty-state__title">尚未設定任何伺服器</h2>
        ...
        <article class="card"
            ...
            <div class="card__body">
                ...
                <dl class="grid gap-2 text-xs"
                    ...
                    <dt class="text-muted flex items-center gap-1" style="margin:0">
                        <i data-lucide="map" style="width:13px;height:13px"></i> 地圖
                    </dt>
                    <dd class="font-mono text-faint" data-testid="server-map" style="margin:0">&mdash;</dd>

                    <dt class="text-muted flex items-center gap-1" style="margin:0">
                        <i data-lucide="users" style="width:13px;height:13px"></i> 玩家
                    </dt>
            ...
            <div id="server-players-{$server.sid}"
                ...
                *}
                ...
                <p class="text-xs text-muted m-0" data-empty-message>目前沒有玩家連線。</p>
