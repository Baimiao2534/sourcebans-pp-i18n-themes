...
<p class="lead">
    最初の管理者アカウントを作成します。このアカウントは
    <strong>Owner</strong> 権限フラグを取得し、パネル内のすべての操作
    （他の管理者の作成を含む）を実行できます。
</p>
...
<form method="post"
    ...
    <div class="install-section">
        ...
        <div class="install-grid">
            <div>
                <label class="label" for="install-admin-uname">ユーザー名</label>
                <input class="input"
            ...
            <div>
                <label class="label" for="install-admin-email">メールアドレス</label>
                <input class="input"
            ...
            <div>
                <label class="label" for="install-admin-pass1">パスワード</label>
                <input class="input"
                       ...
                       required>
                <p class="text-xs text-muted">8文字以上。</p>
            </div>

            <div>
                <label class="label" for="install-admin-pass2">パスワード（確認）</label>
                <input class="input"
            ...
            <div style="grid-column:1/-1">
                ...
                <p class="text-xs text-muted">
                    SteamID は <code>STEAM_0:X:NNNNNNN</code> 形式です。
                    カスタム URL や SteamID64 をお持ちの場合は、
                    <a href="https://steamid.io/" target="_blank" rel="noopener">steamid.io</a>
                    で変換できます。
                </p>
            </div>
        </div>
