...
<form method="get"
    ...
    <div class="card__header">
        <div>
            ...
            <p>Jede Zeile ist ihr eigenes Suchkriterium. Die Schaltfläche &laquo;Suchen&raquo; rechts reicht nur den Wert dieser Zeile ein.</p>
        </div>
    </div>

    <div class="card__body space-y-3">
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <label class="label" for="search-comms-name" style="grid-column:1;align-self:end">Spitzname</label>
            <input class="input"
                   id="search-comms-name"
                   type="text"
                   placeholder="Teilstring-Abgleich gegen den Spieler-Spitznamen&hellip;"
            ...
            <button type="submit"
                ...
                <i data-lucide="search" style="width:14px;height:14px"></i> Suchen
            </button>
        </div>
        ...
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            ...
            <div class="flex gap-2" style="flex-wrap:wrap">
                ...
                <select class="select"
                        ...
                        style="width:9rem">
                    <option value="0" selected>Genaue Übereinstimmung</option>
                    <option value="1">Teilweise Übereinstimmung</option>
                </select>
            </div>
            <button type="submit"
                    class="btn btn--secondary btn--sm"
        ...
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <label class="label" for="search-comms-reason" style="grid-column:1;align-self:end">Grund</label>
            <input class="input"
                   id="search-comms-reason"
                   type="text"
                   placeholder="Teilstring-Abgleich gegen den aufgezeichneten Grund&hellip;"
        ...
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <span class="label" style="grid-column:1;align-self:end">Datum</span>
        ...
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <span class="label" style="grid-column:1;align-self:end">Dauer</span>
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                <select class="select"
                        id="search-comms-length-op"
                        data-testid="search-comms-length-op"
                        style="width:5rem">
                    <option value="e"  title="gleich">=</option>
                    <option value="h"  title="größer">&gt;</option>
                    <option value="l"  title="kleiner">&lt;</option>
                    <option value="eh" title="gleich oder größer">&gt;=</option>
                    <option value="el" title="gleich oder kleiner">&lt;=</option>
                </select>
                <select class="select"
                    ...
                    <optgroup label="Monate">
                        <option value="40320">1 Monat</option>
                        <option value="80640">2 Monate</option>
                        <option value="120960">3 Monate</option>
                        <option value="241920">6 Monate</option>
                        <option value="483840">12 Monate</option>
                    </optgroup>
                    <option value="other">Andere Dauer (Minuten)&hellip;</option>
                </select>
                <input type="text"
        ...
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            <label class="label" for="search-comms-btype">Typ</label>
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                <select class="select"
                        id="search-comms-btype"
                        data-testid="search-comms-btype">
                    <option value="1" selected>Stummschaltung</option>
                    <option value="2">Knebel</option>
                </select>
            </div>
            <button type="submit"
                    class="btn btn--secondary btn--sm"
        ...
        {if NOT $hideadminname}
            <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
                <label class="label" for="search-comms-admin">Administrator</label>
                <div class="flex items-center gap-2" style="flex-wrap:wrap">
                    <select class="select"
        ...
        <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
            ...
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                <select class="select"
                    ...
                    <option value="0" selected>Web-Bann</option>
                    {foreach from=$server_list item="server"}
                        <option value="{$server.sid}"
                                data-sid="{$server.sid}"
                                data-ip="{$server.ip}"
                                data-port="{$server.port}"
                                data-server-host>Laden&hellip; ({$server.ip}:{$server.port})</option>
                    {/foreach}
                </select>
            </div>
            <button type="submit"
        ...
        {if $is_admin}
            <div class="grid gap-3" style="grid-template-columns:10rem 1fr auto;align-items:end">
                <label class="label" for="search-comms-comment" style="grid-column:1;align-self:end">Kommentar</label>
                <input class="input"
                       id="search-comms-comment"
                       type="text"
                       placeholder="Teilstring-Abgleich gegen Administrator-Notizen&hellip;"
