...
<div data-testid="admin-admins-section-add-admin">
    ...
    {else}
        <div class="mb-4">
            <h1 style="font-size:var(--fs-xl);font-weight:600;margin:0">Ajouter un nouvel administrateur</h1>
            <p class="text-sm text-muted m-0 mt-2">Survolez les icônes d&rsquo;aide pour obtenir des conseils par champ.</p>
        </div>
        ...
        <div id="msg-green" class="card" style="display:none;border-left:3px solid var(--success)">
            <div class="card__body">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="font-semibold">Administrateur ajouté</div>
                        <div class="text-sm text-muted">Le nouvel administrateur a été ajouté avec succès. Redirection&hellip;</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form id="add-admin-form" method="post" action="" class="space-y-4" autocomplete="off">
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>Identité</h3>
                        <p>Le nom de connexion et le Steam ID identifient cet administrateur dans le panneau et sur les serveurs de jeu.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    ...
                    <div>
                        <label class="label" for="email">E-mail <span class="text-faint" style="font-weight:400">(requis pour l&rsquo;accès web)</span></label>
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        ...
                        <p>Mot de passe du panneau web et mot de passe administrateur en jeu optionnel.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    <div class="grid gap-4" style="grid-template-columns:1fr 1fr">
                        <div>
                            <label class="label" for="password">Mot de passe <span class="text-faint" style="font-weight:400">(requis pour l&rsquo;accès web)</span></label>
                    ...
                    <div class="flex items-center gap-2 mt-2" style="border-top:1px solid var(--border);padding-top:0.75rem">
                        ...
                        <label for="a_useserverpass" class="text-sm font-medium" style="margin:0">Définir un mot de passe administrateur en jeu</label>
                        <input class="input" id="a_serverpass" name="a_serverpass" type="password"
                               ...
                               aria-label="Mot de passe administrateur en jeu">
                    </div>
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>Accès aux serveurs</h3>
                        <p>Serveurs et groupes de serveurs que l&rsquo;administrateur pourra gérer en jeu.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    {if !$group_list && !$server_list}
                        <p class="text-sm text-muted m-0"><em>Aucun serveur ou groupe de serveurs n&rsquo;a été ajouté pour le moment.</em></p>
                    {else}
                        {if $group_list}
                            <div class="text-xs text-faint" style="text-transform:uppercase;letter-spacing:0.06em;font-weight:600">Groupes de serveurs</div>
                        ...
                        {/if}
                        {if $server_list}
                            <div class="text-xs text-faint" style="text-transform:uppercase;letter-spacing:0.06em;font-weight:600;margin-top:0.5rem">Serveurs individuels</div>
                            {*
            ...
            <div class="card">
                <div class="card__header">
                    <div>
                        <h3>Permissions</h3>
                        <p>Groupes prédéfinis, drapeaux personnalisés, ou aucune permission. Le choix « Nouveau groupe » ouvre un éditeur intégré.</p>
                    </div>
                </div>
                <div class="card__body space-y-3">
                    <div>
                        <label class="label" for="serverg">Groupe d&rsquo;administration serveur</label>
                        ...
                        <select class="select" id="serverg" name="serverg" tabindex="8"
                            ...
                            <option value="-2">Veuillez sélectionner&hellip;</option>
                            <option value="-3">Aucune permission</option>
                            <option value="c">Permissions personnalisées</option>
                            <option value="n">Nouveau groupe d&rsquo;administrateurs</option>
                            <optgroup label="Groupes" style="font-weight:bold">
                        ...
                        <div id="serverperm" style="overflow:hidden">
                            <div id="server-new-name-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="server-new-name">Nom du nouveau groupe d&rsquo;administration serveur</label>
                            ...
                            <div id="server-flags-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="server-flags">Drapeaux et immunité SourceMod</label>
                                ...
                                <p class="text-xs text-muted m-0 mt-2">
                                    Chaîne de drapeaux SourceMod. Ajoutez <code>#&lt;immunité&gt;</code> pour l&rsquo;immunité (par défaut 0).
                                </p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <label class="label" for="webg">Groupe d&rsquo;administration web</label>
                        ...
                        <div id="webperm" style="overflow:hidden">
                            <div id="web-new-name-block" hidden style="margin-top:0.75rem">
                                <label class="label" for="web-new-name">Nom du nouveau groupe d&rsquo;administration web</label>
                            ...
                            <div id="web-flags-block" hidden style="margin-top:0.75rem">
                                <fieldset style="border:1px solid var(--border);border-radius:var(--radius-md);padding:0.75rem">
                                    <legend class="text-xs text-faint" style="padding:0 0.5rem;text-transform:uppercase;letter-spacing:0.06em;font-weight:600">Permissions web</legend>
                                    <p class="text-xs text-muted m-0 mb-2">Choisissez les drapeaux que cet administrateur (ou nouveau groupe) détient. Le propriétaire accorde tous les autres drapeaux.</p>
                                    <div class="grid gap-2" style="grid-template-columns:repeat(auto-fill,minmax(16rem,1fr))">
                                        ...
                                        {if $can_grant_owner}
                                            {* #1402 adversarial review HIGH 1: OWNER is gated.
                                               ...
                                               affordance half. *}
                                            <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_OWNER" data-testid="admin-add-flag-owner"> <span class="text-sm">Propriétaire</span></label>
                                        {/if}
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_ADMINS"> <span class="text-sm">Voir les administrateurs</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_ADMINS"> <span class="text-sm">Ajouter des administrateurs</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_ADMINS"> <span class="text-sm">Modifier les administrateurs</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_ADMINS"> <span class="text-sm">Supprimer les administrateurs</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_SERVERS"> <span class="text-sm">Voir les serveurs</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_SERVER"> <span class="text-sm">Ajouter des serveurs</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_SERVERS"> <span class="text-sm">Modifier les serveurs</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_SERVERS"> <span class="text-sm">Supprimer les serveurs</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_BAN"> <span class="text-sm">Ajouter des bannissements</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_OWN_BANS"> <span class="text-sm">Modifier ses bannissements</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_GROUP_BANS"> <span class="text-sm">Modifier les bannissements du groupe</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_ALL_BANS"> <span class="text-sm">Modifier tous les bannissements</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_UNBAN"> <span class="text-sm">Débannir tous les bannissements</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_UNBAN_OWN_BANS"> <span class="text-sm">Débannir ses bannissements</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_UNBAN_GROUP_BANS"> <span class="text-sm">Débannir les bannissements du groupe</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_BAN"> <span class="text-sm">Supprimer tous les bannissements</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_PROTESTS"> <span class="text-sm">Appels de bannissement</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_SUBMISSIONS"> <span class="text-sm">Signalements de bannissement</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_BAN_IMPORT"> <span class="text-sm">Importer des bannissements</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_GROUPS"> <span class="text-sm">Voir les groupes</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_GROUP"> <span class="text-sm">Ajouter des groupes</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_GROUPS"> <span class="text-sm">Modifier les groupes</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_GROUPS"> <span class="text-sm">Supprimer les groupes</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_WEB_SETTINGS"> <span class="text-sm">Paramètres web</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_LIST_MODS"> <span class="text-sm">Voir les mods</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_ADD_MODS"> <span class="text-sm">Ajouter des mods</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_EDIT_MODS"> <span class="text-sm">Modifier les mods</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_DELETE_MODS"> <span class="text-sm">Supprimer les mods</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_NOTIFY_SUB"> <span class="text-sm">Notifications e-mail de signalement</span></label>
                                        <label class="flex items-center gap-2"><input type="checkbox" data-flag="ADMIN_NOTIFY_PROTEST"> <span class="text-sm">Notifications e-mail d&rsquo;appel</span></label>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
            ...
            <div class="flex justify-end gap-2">
                <button type="button" class="btn btn--ghost btn--sm"
                        onclick="history.go(-1);" data-testid="admin-add-back">Retour</button>
                <button type="submit" class="btn btn--primary btn--sm" id="aadmin"
                        data-testid="admin-add-submit"><i data-lucide="user-plus"></i> Ajouter un administrateur</button>
            </div>
        </form>
        ...
        (function () {
            ...
            document.addEventListener('click', function (e) {
                ...
                a.call(A.AdminsGeneratePassword, {}).then(function (r) {
                    ...
                    setBusy(btn, false);
                    toast('error', 'Échec de la génération du mot de passe', String(err && err.message ? err.message : err));
                });
            });
            ...
            document.addEventListener('submit', function (e) {
                ...
                a.call(A.AdminsAdd, {
                    ...
                    if (r.ok === false) {
                        ...
                        showMsg(slot, em);
                        toast('error', "Échec de l'ajout de l'administrateur", em);
                        return;
                    }
                    var data = r.data || {};
                    var msg = data.message || {};
                    toast('success', msg.title || 'Administrateur ajouté', msg.body || "L'administrateur a été ajouté.");
                    ...
                    setBusy(submitBtn, false);
                    toast('error', "Échec de l'ajout de l'administrateur", String(err && err.message ? err.message : err));
                });
            });
