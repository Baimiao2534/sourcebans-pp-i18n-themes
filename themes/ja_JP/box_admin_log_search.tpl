...
<form method="get"
    ...
    <div class="card__header">
        <div>
            <h3>高度な検索</h3>
            <p>管理者、メッセージテキスト、日付範囲、または重大度でシステムログを絞り込みます。</p>
        </div>
    </div>
    ...
    <div class="card__body space-y-3">
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <div>
                <label class="label" for="search-log-admin">管理者</label>
                <select class="select"
                        id="search-log-admin"
            ...
            <div class="text-xs text-muted">管理者を選択すると、そのアカウントの操作に絞り込みます。</div>
            <button type="submit"
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <label class="label" for="search-log-message" style="grid-column:1;align-self:end">メッセージ</label>
            <input class="input"
                   id="search-log-message"
                   type="text"
                   placeholder="ログメッセージの部分一致&hellip;"
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <span class="label" style="grid-column:1;align-self:end">日付範囲</span>
            <div class="flex items-center gap-2" style="flex-wrap:wrap">
                ...
                <input class="input font-mono" style="width:4.25rem" type="text" maxlength="4" placeholder="YYYY"
                       ...
                       inputmode="numeric"
                       pattern="[0-9]*">
                <span class="text-muted text-xs" style="margin-left:0.5rem">から</span>
                ...
                <input class="input font-mono" style="width:3rem" type="text" maxlength="2" value="00"
                       ...
                       inputmode="numeric"
                       pattern="[0-9]*">
                <span class="text-muted text-xs" style="margin-left:0.5rem">まで</span>
        ...
        <div class="grid gap-3" style="grid-template-columns:14rem 1fr auto;align-items:end">
            <div>
                <label class="label" for="search-log-type">タイプ</label>
                <select class="select"
                        id="search-log-type"
                        data-testid="search-log-type">
                    <option value="m">情報</option>
                    <option value="w">警告</option>
                    <option value="e">エラー</option>
                </select>
            </div>
            <div class="text-xs text-muted">単一の重大度レベルに絞り込みます。</div>
            <button type="submit"
                    class="btn btn--secondary btn--sm"
